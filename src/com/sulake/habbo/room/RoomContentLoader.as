package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_865:String = "RCL_LOADER_READY";
      
      private static const const_390:String = "RCL_PUBLICROOM_";
      
      private static const const_2120:int = 0;
      ...
      private static const const_699:String = "pet_place_holder";
      ...
      private static const const_1083:String = "selection_arrow";
      ...
      private var var_1017:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1016:Map = null;
      
      private var var_216:PublicRoomData = null;
      
      private var var_1524:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2544 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2541 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1082)
         {
            return;
         }
         this.var_1525 = param1;
         this.var_2542 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2540 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1017.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_547.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_547.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_462.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_462.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_805.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_463.add(_loc3_,_loc4_);
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_646.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_647.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_647.remove(_loc7_);
               this.var_647.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2543)
         {
            ...
            {
               this.var_1525.dispatchEvent(new Event(const_865));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_546 != null)
         {
            this.var_546.remove(param1);
            this.var_546.add(param1,param2);
         }
         if(this.var_545 != null)
         {
            this.var_545.remove(param2);
            this.var_545.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_546 != null)
         {
            _loc2_ = this.var_546.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_545 != null)
         {
            _loc2_ = this.var_545.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_216 != null && (this.var_216.type == param1 || this.var_216.hasWorldType(param1)))
         {
      ...
      {
         return [const_480,const_701,const_699,const_700,TILE_CURSOR,const_1083];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_463.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_646.getValue(param1) as String;
      ...
      {
         return this.var_1017.getValue(param1) as String;
      }
      ...
      {
         var _loc2_:String = this.var_646.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_805.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_216 != null && this.var_216.hasWorldType(const_390 + param1))
         {
            return this.var_216.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_266 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_647.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_27:
               this.var_463[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_26:
               this.var_646[param1] = _loc4_;
               break;
            default:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1524.getValue(param1) != null)
         {
            this.var_216 = this.var_1524.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_959,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2544.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1828);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2541.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_604,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1524.add(param1,_loc4_);
         this.var_216 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_806.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_806.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_547.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_806.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_547.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_547.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_585.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_462.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_462.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_462[_loc2_] != null)
         {
            _loc3_ = this.var_462.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_390 + param1) == RoomObjectCategoryEnum.const_82)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_216.getWorldHeightScale(const_390 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_216 != null)
         {
            return this.var_216.getWorldScale(const_390 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_463.remove(param1);
         this.var_463.add(param1,param2);
      }
   }
}
