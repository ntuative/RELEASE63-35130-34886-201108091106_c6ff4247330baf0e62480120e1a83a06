package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_710:Number = 0.25;
      
      private static const const_1419:Number = 0.25;
      
      public static const const_60:int = -110;
      
      public static const const_217:int = -100;
      ...
      private var var_1569:Number = 1.0;
      
      private var var_1040:Number = 1.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_135.push(_loc4_);
            this.var_561.push(_loc5_);
            this.var_560.push(_loc6_);
            _loc3_++;
         }
         this.var_220 = param1;
         this._height = param2;
         this._minX = this.var_220;
         this.var_472 = -1;
         this.var_473 = this._height;
         this.var_471 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_220 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_135[param2] as Array;
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_472)
               {
                  this.var_472 = param1;
               }
               if(param2 < this.var_473)
               {
                  this.var_473 = param2;
               }
               if(param2 > this.var_471)
               {
                  this.var_471 = param2;
               }
            }
            ...
            {
               if(param1 == this._minX || param1 == this.var_472)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_473;
                  while(_loc6_ < this.var_471)
                  {
               ...
               if(param2 == this.var_473 || param2 == this.var_471)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_472)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_135[param2] as Array;
      ...
      private function getTileHeightOriginal(param1:int, param2:int) : Number
      {
         ...
         if(this.var_560[param2][param1])
         {
            return const_217;
         }
         var _loc3_:Array = this.var_561[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_220)
            {
               this.var_561[_loc3_][_loc2_] = this.var_135[_loc3_][_loc2_];
               _loc2_++;
            }
            _loc3_++;
         }
         var _loc4_:Point = findEntranceTile(this.var_135);
         _loc3_ = 0;
         while(_loc3_ < this._height)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_220)
            {
               if(this.var_560[_loc3_][_loc2_])
               {
                  this.setTileHeight(_loc2_,_loc3_,const_217);
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         this.var_1032 = getFloorHeight(this.var_135);
         if(!param2)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_135.length)
         {
            _loc4_ = this.var_135[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function updateWallsNextToHoles(param1:RoomWallData) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(!param1.getHideWall(_loc3_))
            {
               ...
               _loc7_ = RoomWallData.var_430[_loc5_];
               _loc8_ = RoomWallData.var_513[_loc5_];
               _loc9_ = 0;
               _loc10_ = 0;
               while(_loc10_ < _loc6_)
               {
                  if(this.getTileHeightInternal(_loc4_.x + _loc10_ * _loc7_.x - _loc8_.x,_loc4_.y + _loc10_ * _loc7_.y - _loc8_.y) == const_217)
                  {
      ...
      private function hideOriginallyHiddenWalls(param1:RoomWallData, param2:RoomWallData) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(!param1.getHideWall(_loc4_))
            {
               ...
               _loc7_ = RoomWallData.var_430[param1.getDirection(_loc4_)];
      ...
      private function addWalls(param1:RoomWallData, param2:RoomWallData) : void
      {
         ...
         while(_loc7_ < _loc3_)
         {
            if(!param1.getHideWall(_loc7_))
            {
               ...
               _loc11_ = RoomWallData.var_430[_loc9_];
               _loc12_ = RoomWallData.var_513[_loc9_];
               _loc13_ = -1;
               _loc14_ = 0;
               ...
               {
                  _loc21_ = RoomWallData.var_513[_loc5_];
               }
               else if((_loc9_ - _loc6_ + 4) % 4 == 3)
               {
                  _loc21_ = RoomWallData.var_513[_loc6_];
               }
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_217)
            {
               _loc9_--;
               break;
            }
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_317,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_412,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1419 * this.var_1569;
         var _loc9_:Number = const_710 * this.var_1040;
         ...
         this.addPlane(RoomPlaneData.const_317,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_317,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_317,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_317,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function getHeightMapWidth(param1:Array) : int
      {
         ...
         while(_loc6_ < _loc2_)
         {
            ...
            _loc4_ = this.var_135[_loc6_] as Array;
      ...
      private function extractFloorPlane(param1:Array, param2:Boolean) : Boolean
      {
         ...
         if(param1 == null || this.var_135 == null || param1 == this.var_135)
         {
            return false;
         }
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:* = null;
         if(param1.length > this.var_135.length)
         {
            return false;
         }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_255,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_710 * this.var_1040;
            _loc19_ = _loc18_;
            if(this.var_1040 > 1)
            {
               _loc19_ = const_710;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_255,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_255,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_255,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_255,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_220}" height="{this._height}" wallHeight="{this.var_1568}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc7_ = <tileRow/>;
            _loc8_ = this.var_561[_loc2_];
            _loc9_ = 0;
            while(_loc9_ < this.var_220)
            {
               _loc10_ = _loc8_[_loc9_];
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_332.length)
         {
            _loc12_ = this.var_332.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_332.getKey(_loc4_);
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1397;
         }
         var _loc2_:RoomPlaneData = this.var_155[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_332.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_332.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc2_ < this._height)
         {
            _loc3_ = this.var_560[_loc2_];
            _loc1_ = 0;
            while(_loc1_ < this.var_220)
            {
               _loc3_[_loc1_] = false;
               _loc1_++;
            }
         ...
         while(_loc4_ < this.var_332.length)
         {
            _loc5_ = this.var_332.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
               ...
               _loc7_ = _loc7_ >= this.var_220 ? int(this.var_220 - 1) : int(_loc7_);
