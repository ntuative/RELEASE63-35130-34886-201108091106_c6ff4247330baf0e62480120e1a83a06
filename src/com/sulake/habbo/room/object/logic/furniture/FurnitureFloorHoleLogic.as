package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFloorHoleLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_476:int = 0;
      ...
      {
         if(this.var_1199 == const_476)
         {
            eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_162,object.getId(),object.getType()));
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectFloorHoleEvent.const_159,RoomObjectFloorHoleEvent.const_162];
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc4_ != this.var_1199)
               {
                  if(eventDispatcher != null)
                  {
                     if(_loc4_ == const_476)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_159,object.getId(),object.getType()));
                     }
                     else if(this.var_1199 == const_476)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_162,object.getId(),object.getType()));
                     }
                  }
