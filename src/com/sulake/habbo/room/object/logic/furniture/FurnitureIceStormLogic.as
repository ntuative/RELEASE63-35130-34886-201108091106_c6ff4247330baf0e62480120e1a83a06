package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2487:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1838 = _loc2_;
            this.var_2487 = param1.extra;
            this.var_1227 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1227 > 0 && param1 >= this.var_1227)
         {
            this.var_1227 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1838,String(this.var_1838),this.var_2487);
