package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_179,RoomObjectWidgetRequestEvent.const_117,RoomObjectDimmerStateUpdateEvent.const_68];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1770)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_117,_loc1_,_loc2_);
