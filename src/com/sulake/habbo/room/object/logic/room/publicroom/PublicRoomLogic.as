package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_218,RoomObjectRoomAdEvent.const_335,RoomObjectRoomAdEvent.const_354];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_460,"");
         _loc2_.setString(RoomObjectVariableEnum.const_917,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_548,Number(false));
         this.var_907 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1487 > 0 && param1 > this.var_1487)
         {
            this.adDelayTimeout();
            this.var_1487 = 0;
         }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1236:
                  _loc2_.setString(RoomObjectVariableEnum.const_460,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_917,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_548,Number(true));
                  this.var_1487 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1251);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_548,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_581)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_917);
