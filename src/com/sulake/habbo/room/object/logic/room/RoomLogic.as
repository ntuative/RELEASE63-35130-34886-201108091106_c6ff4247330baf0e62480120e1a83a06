package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1527:uint = 16777215;
      
      private var var_1878:int = 255;
      
      private var var_1244:uint = 16777215;
      
      private var var_1879:int = 255;
      
      private var var_1243:int = 0;
      
      private var var_1881:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_590,RoomObjectMouseEvent.const_160];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_767,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_798,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_952,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1015,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_982,1);
         }
      }
         ...
         if(this.var_1528)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_767,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1387,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1243)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1880;
            if(_loc2_ - this.var_1243 >= this.var_1881)
            {
               _loc3_ = this.var_1244;
               _loc4_ = this.var_1879;
               this.var_1243 = 0;
            }
            else
            {
               _loc7_ = this.var_1527 >> 16 & 255;
               _loc8_ = this.var_1527 >> 8 & 255;
               _loc9_ = this.var_1527 & 255;
               _loc10_ = this.var_1244 >> 16 & 255;
               _loc11_ = this.var_1244 >> 8 & 255;
               _loc12_ = this.var_1244 & 255;
               _loc13_ = (_loc2_ - this.var_1243) / this.var_1881;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1878 + (this.var_1879 - this.var_1878) * _loc13_;
               this._color = _loc3_;
               this.var_1880 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_798,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_1000:
               param2.setString(RoomObjectVariableEnum.const_209,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_940:
               param2.setString(RoomObjectVariableEnum.const_223,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_780:
               param2.setString(RoomObjectVariableEnum.const_207,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_608:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_853:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1222,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1357:
               param2.setNumber(RoomObjectVariableEnum.const_952,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1427:
               param2.setNumber(RoomObjectVariableEnum.const_1015,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_982,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_710:
               param2.setNumber(RoomObjectVariableEnum.const_1443,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1419:
               param2.setNumber(RoomObjectVariableEnum.const_1373,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_159:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1528 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_162:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1378,int(param1.bgOnly));
         this.var_1527 = this._color;
         this.var_1878 = this.var_1880;
         this.var_1244 = _loc3_;
         this.var_1879 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_516,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_2083,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1907,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1852,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_516,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_317 || _loc12_ == RoomPlaneData.const_412)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
