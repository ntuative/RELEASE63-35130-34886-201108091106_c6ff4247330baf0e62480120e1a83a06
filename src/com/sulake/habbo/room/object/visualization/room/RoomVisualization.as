package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_2020:int = 16777215;
      
      public static const const_1971:int = 13421772;
      
      private static const const_1127:int = 16777215;
      
      private static const const_1128:int = 13421772;
      
      private static const const_1125:int = 10066329;
      
      private static const const_1126:int = 10066329;
      
      public static const const_1887:int = 16777215;
      
      public static const const_1988:int = 13421772;
      
      public static const const_2006:int = 10066329;
      ...
      private var var_839:Rectangle = null;
      
      private var var_568:RoomPlaneBitmapMaskParser = null;
      
      private var var_1489:String = null;
      
      private var _floorType:String = null;
      
      private var var_1488:String = null;
      
      private var var_1040:Number = NaN;
      
      private var var_1569:Number = NaN;
      
      private var var_2713:Number = NaN;
      
      private var var_2012:String = null;
      
      private var var_1288:uint = 16777215;
      
      private var var_2712:int = 255;
      
      private var var_2714:int = 255;
      
      private var var_2715:int = 255;
      
      private var var_2013:Boolean = true;
      
      private var var_1289:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_2405:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_336["null"] = false;
         this.var_336["null"] = true;
         this.var_336["null"] = true;
         this.var_336["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_839 = super.boundingRectangle;
         }
         return new Rectangle(this.var_839.x,this.var_839.y,this.var_839.width,this.var_839.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_69 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_69)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1040))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1040;
         }
         if(!isNaN(this.var_1569))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1569;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_767);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1242);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_69,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_412)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_2061)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_69,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_412)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2405 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_398.length)
            {
               _loc11_ = this.var_684[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_398[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2013)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2715 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2714 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2712 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1832)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1507 || _loc3_.y != this.var_2483 || _loc3_.z != this.var_2484 || param1.scale != this.var_2011))
            {
               this.var_1507 = _loc3_.x;
               this.var_2483 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_150 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1222);
            if(_loc3_ != this.var_2012)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2012 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_798));
            if(_loc4_ != this.var_1288)
            {
               this.var_1288 = _loc4_;
               this.var_2715 = this.var_1288 & 255;
               this.var_2714 = this.var_1288 >> 8 & 255;
               this.var_2712 = this.var_1288 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1378));
            if(_loc5_ != this.var_2013)
            {
               this.var_2013 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_207);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_952));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1015));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_982));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1443);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1373);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1040 || _loc3_ != this.var_1569))
            {
               this.var_1040 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1387);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2713)
            {
               this.var_2713 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_155.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_69 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_336["null"] || param2 != this.var_336["null"] || param3 != this.var_336["null"])
         {
            this.var_336["null"] = param1;
            this.var_336["null"] = param2;
            this.var_336["null"] = param3;
            this.var_398 = [];
            this.var_684 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_398;
         if(this.var_398.length == 0)
         {
            _loc6_ = this.var_155;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_398.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_336[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_398.push(_loc12_);
                        this.var_684.push(_loc9_);
                     }
                  }
               }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_568.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_568.maskCount)
         {
            _loc10_ = this.var_568.getMaskType(_loc8_);
            _loc11_ = this.var_568.getMaskLocation(_loc8_);
            _loc12_ = this.var_568.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_155.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_69 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_69 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_315)
                              {
