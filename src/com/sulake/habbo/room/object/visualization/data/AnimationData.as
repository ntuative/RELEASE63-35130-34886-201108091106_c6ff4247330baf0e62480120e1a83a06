package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2169:int = 0;
      ...
      private var var_131:Map = null;
      
      private var var_460:int = -1;
      
      private var var_2162:Boolean = false;
      
      private var var_1671:Array = null;
      
      public function AnimationData()
      {
         super();
         this.var_131 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_131 != null)
         {
            ...
            {
               _loc2_ = this.var_131.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1671 != null && this.var_1671.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_131.add(param1,_loc6_);
         ...
         if(_loc3_.length() > 0)
         {
            ...
            while(_loc7_ < _loc6_.length())
            {
               ...
               if(XMLValidator.checkRequiredAttributes(_loc8_,_loc4_))
               {
                  ...
                  _loc2_.method_2(_loc9_,_loc10_,_loc11_);
               }
               _loc7_++;
            }
         }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_131.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_131.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
