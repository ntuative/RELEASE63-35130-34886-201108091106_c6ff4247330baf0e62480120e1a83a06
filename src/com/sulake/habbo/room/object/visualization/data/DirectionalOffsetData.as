package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class DirectionalOffsetData
   {
      ...
      {
         if(this.var_1175[param1] == null)
         {
            return param2;
         }
         return this.var_1175[param1];
      }
      
      public function method_2(param1:int, param2:int, param3:int) : void
      {
         this._offsetX[param1] = param2;
         this.var_1175[param1] = param3;
      }
   }
}
