package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public static const const_973:int = -1;
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_753.add(_loc6_,_loc7_);
         ...
         if(this.var_753.getValue(this.var_934) == null)
         {
            return false;
         }
         return true;
      ...
      {
         if(this.var_753.getValue(param1) == null)
         {
            param1 = this.var_934;
         }
         return int(this.var_753.getValue(param1));
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_753.length)
         {
            return this.var_753.getKey(param1);
         }
         return this.var_934;
      }
