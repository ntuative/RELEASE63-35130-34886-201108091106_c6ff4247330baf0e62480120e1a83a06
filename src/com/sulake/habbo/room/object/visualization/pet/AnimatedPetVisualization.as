package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1600:String = "head";
      
      private static const const_711:int = 1;
      
      private static const const_1114:int = 1000;
      
      private static const const_1601:String = "pet_experience_bubble_png";
      
      private static const const_1603:int = 0;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1043 = [];
         super();
         while(this.var_136.length < ANIMATION_INDEX_COUNT)
         {
            this.var_136.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_136 != null)
         {
            ...
            {
               _loc2_ = this.var_136[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1601) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2672)
            {
               this.var_2672 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_150)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_318);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_181);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_318);
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_103);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_103,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_181);
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_103);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_103,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_2039 = _loc3_.getNumber(RoomObjectVariableEnum.const_294) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_237);
            if(!isNaN(_loc8_))
            {
               this.var_1963 = _loc8_;
            }
            else
            {
               this.var_1963 = direction;
            }
            this.var_1571 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2401 = _loc3_.getNumber(RoomObjectVariableEnum.const_437);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_794);
            if(_loc9_ != this.var_1964)
            {
               this.var_1964 = _loc9_;
               this.var_2671 = this.var_1964.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_391 != null)
         {
            ...
            if(this.var_1571 > 0)
            {
               _loc2_ = param1 - this.var_1571;
               if(_loc2_ < const_1114)
               {
                  this.var_391.alpha = int(Math.sin(_loc2_ / const_1114 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_295)
         {
            this.var_295 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_103,param1);
            this.setAnimationForIndex(const_1603,_loc3_);
         }
         if(param2 != this.var_1614)
         {
            this.var_1614 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_103,param2);
            this.setAnimationForIndex(const_1602,_loc3_);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_136.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1572 = false;
         var _loc1_:int = this.var_136.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_136[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_136.length)
         {
            _loc5_ = this.var_136[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_136.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_136[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_136.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_136[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2671);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_711)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_538.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_538[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1963);
         }
         return direction;
      }
      ...
      {
         if(this.var_1043[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1600)
            {
               this.var_1043[param1] = true;
            }
            else
            {
               this.var_1043[param1] = false;
            }
         }
         return this.var_1043[param1];
      }
   }
}
