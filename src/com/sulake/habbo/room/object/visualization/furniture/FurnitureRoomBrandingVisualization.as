package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1522:String = "branded_image";
      
      private static const const_1525:int = 0;
      
      private static const const_1523:int = 1;
      ...
      protected var var_1434:Boolean = false;
      
      protected var var_1728:int;
      
      protected var var_1727:int;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1728 = _loc4_.getNumber(RoomObjectVariableEnum.const_682);
                  this.var_1727 = _loc4_.getNumber(RoomObjectVariableEnum.const_670);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_618);
               }
            }
         }
         if(!this.var_1434)
         {
            this.var_1434 = this.checkIfImageReady();
            if(this.var_1434)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_332);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_577);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1522)
         {
