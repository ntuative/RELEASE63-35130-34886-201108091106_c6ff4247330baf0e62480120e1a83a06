package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_130:AnimationStateData;
      ...
      {
         super();
         this.var_130 = new AnimationStateData();
      }
      ...
      {
         return this.var_130.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1383 && this._animationData.hasAnimation(this.var_453,_loc2_))
         {
            return _loc2_;
         }
         return const_1383;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_1041);
                  this.var_1807 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_1041);
                     if(_loc5_ > this.var_1807)
                     {
                        this.var_1807 = _loc5_;
                        this.setAnimation(this._state);
                     }
                  }
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_860);
                  if(!isNaN(_loc4_))
                  {
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_130,param1,this._state >= 0);
         }
      }
      ...
      {
         return this.var_130.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_130 != null)
         {
            this.var_130.setLayerCount(this.var_729);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_453 = param1;
            this.var_729 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_130.animationOver || this.var_997)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_130,param1);
            if(this.var_130.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_130.animationId) || AnimationData.isTransitionToAnimation(this.var_130.animationId))
               {
                  this.setAnimation(this.var_130.animationAfterTransitionId);
                  this.var_130.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_997)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_729 - 1;
         var _loc8_:int = this.var_729 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_997)
            {
               ...
               if(this.var_997 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1314)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_529)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_130.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_130.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
