package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_497:IButtonWindow;
      
      private var var_1403:ITextWindow;
      
      private var var_1143:int = -1;
      
      private var var_3158:String = "";
      
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         super(param1);
         this.var_497 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1403 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_497 != null)
         {
            this.var_497.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_497.disable();
         }
         this.var_1404 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1404 != null)
         {
            this.var_1404.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_497 != null)
         {
            this.var_497.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_127);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_228);
            this._soundManager.musicController.playSong(this.var_1143,HabboMusicPrioritiesEnum.const_228,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1143 = parseInt(_loc2_.extraParam);
            if(this.var_1404 != null)
            {
               this.var_1404.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1403.text = _loc8_;
            }
         }
         else if(this.var_1403 != null)
         {
            this.var_1403.text = "";
         }
         if(this.var_497 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1143);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1143);
         }
         return -1;
      }
