package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1073:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1073.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1073 = null;
         }
         if(this.var_1072 != null)
         {
            this.var_1072.removeEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
            this.var_1072 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1073 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1073 != null)
         {
            this.var_1073.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1072 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1072 != null)
         {
            this.var_1072.addEventListener(WindowKeyboardEvent.const_182,this.windowKeyEventProcessor);
         }
         return true;
      }
