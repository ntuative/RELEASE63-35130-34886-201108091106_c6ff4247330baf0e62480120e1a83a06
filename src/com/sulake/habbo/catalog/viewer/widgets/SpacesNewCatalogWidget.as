package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_505:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_505 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_505)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_505.numSelectables)
            {
               _loc4_ = this.var_505.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_119[this.var_494]);
      ...
      {
         var _loc2_:int = this.var_748[this.var_494];
         var _loc3_:Offer = this.var_227[this.var_494][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_517.numGridItems)
         {
            _loc2_ = this.var_227[this.var_494][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_748[this.var_494] = (this.var_227[this.var_494] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_748[0];
         var _loc2_:int = this.var_748[1];
         var _loc3_:int = this.var_748[2];
         var _loc4_:Offer = this.var_227[0][_loc1_];
         var _loc5_:Offer = this.var_227[1][_loc2_];
         var _loc6_:Offer = this.var_227[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_455 || _loc1_.pricingModel == Offer.const_441))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_74))
            {
               continue;
            }
            ...
            while(this.var_227.length < this._groupNames.length)
            {
               this.var_227.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_227[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_227[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_505.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_505.setSelected(this.var_505.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_517)
            {
               var_517.destroyGridItems();
            }
            page.replaceOffers(this.var_227[this.var_494],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_748[this.var_494];
