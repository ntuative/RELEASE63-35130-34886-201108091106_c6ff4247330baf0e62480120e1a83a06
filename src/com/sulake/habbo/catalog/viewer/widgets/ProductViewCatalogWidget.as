package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1784:Point;
      
      private var var_534:IItemGridWindow;
      
      private var var_1478:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_191.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_191 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_986 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1193 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_98 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_191 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_191 != null)
         {
            this.var_191.visible = false;
            this.var_533 = this.var_191.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_533 != null && _loc3_ != null)
            {
               this.var_191.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
         ...
         this.var_1784 = new Point(this.var_98.x,this.var_98.y);
         this.var_534 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1478 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_986.text = _loc4_;
         this.var_1193.text = _loc5_;
         this.var_986.height = this.var_986.textHeight + 5;
         this.var_1193.y = this.var_986.y + this.var_986.height;
         this.var_1193.height = Math.max(130,this.var_1193.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_683:
                  ...
                  if(this.var_534 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_534,this.var_1478,this.var_2140);
               ...
               case Offer.const_441:
                  ...
                  if(this.var_191 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_74 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_183)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_183:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_98.width,this.var_98.height,false,_loc15_);
                           _loc16_ = null;
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_356,AvatarAction.const_518);
                                 _loc18_.appendAction(AvatarAction.const_372,_loc9_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_98);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2376)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2376 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_98 != null && true)
         {
            ...
            if(this.var_98.bitmap == null)
            {
               this.var_98.bitmap = new BitmapData(this.var_98.width,this.var_98.height,true,16777215);
            }
            this.var_98.bitmap.fillRect(this.var_98.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_98.width - param1.width) / 2,(this.var_98.height - param1.height) / 2);
            this.var_98.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_98.invalidate();
            this.var_98.x = this.var_1784.x;
            this.var_98.y = this.var_1784.y;
            if(param3 != null)
            {
               this.var_98.x += param3.x;
               this.var_98.y += param3.y;
            }
         }
         if(param2)
         {
