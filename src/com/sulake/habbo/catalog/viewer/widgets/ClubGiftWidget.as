package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private const const_249:int = 31;
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc2_ = _loc7_ >= this.const_249 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _loc7_ % this.const_249;
            _loc4_ = _loc7_ / this.const_249;
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_27.purse.pastVipDays >= this.const_249 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_27.purse.pastVipDays % this.const_249;
            _loc4_ = this.var_27.purse.pastVipDays / this.const_249;
            this.var_27.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_27.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            if(_loc6_ >= this.const_249)
            {
               _loc7_ += ".long";
            }
            _loc12_ = _loc6_ % this.const_249;
            _loc13_ = _loc6_ / this.const_249;
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_264)
         {
            this.var_264 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_264)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_264.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_264.setGlobalPosition(_loc6_.subtract(new Point(this.var_264.width / 2,this.var_264.height / 2)));
         this.var_264.visible = true;
         this.var_264.activate();
      }
