package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization
   {
      ...
      private var var_276:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_214)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_214)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.const_25:
               if(this.var_276 != null)
               {
                  this.var_276.resetIcon();
               }
               break;
            case WindowMouseEvent.const_194:
               if(this.var_276 != null)
               {
                  this.var_276.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_276 == null)
               {
                  this.var_276 = new CatalogObjectMover();
                  this.var_276.mainContainer = window;
                  this.var_276.roomEngine = _loc3_;
               }
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_194)
         {
