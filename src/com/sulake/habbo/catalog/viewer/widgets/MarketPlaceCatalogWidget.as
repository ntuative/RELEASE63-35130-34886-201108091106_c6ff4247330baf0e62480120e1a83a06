package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2127:int = 1;
      
      private const const_2126:int = 2;
      
      private const const_2403:int = 40;
      
      private const const_2404:int = 10;
      
      private var var_838:Array;
      
      private var var_1591:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_566)
         {
            this.var_566.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_566 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_838 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_838 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_838));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_682)
         {
            ...
            this.var_682 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_682)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2126,_loc3_.length,_loc2_);
         if(!this.var_566)
         {
            this.var_566 = new Timer(25);
            this.var_566.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1287 = 0;
         this.populateList();
         this.var_566.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1287 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1287));
            ++this.var_1287;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_682 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_682.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2127);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_838.length)
         {
            _loc4_ = this.var_838[_loc6_.selection];
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_119)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2404;
                  break;
               case "search_input":
                  _loc8_ = this.const_2403;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1591.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_47)
