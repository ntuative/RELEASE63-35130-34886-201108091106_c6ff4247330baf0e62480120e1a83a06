package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1484:int = 18;
      ...
      private var var_221:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_119,this.onTextWindowEvent);
         ...
         this.var_538 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_538 < 8)
         {
            return false;
         }
         this.var_2426 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_221 != null && this.var_221.length > 0)
         {
            this.var_371 = this.var_221[0];
         }
         else
         {
            this.var_371 = -1;
         }
         this._offers.add(this.var_538,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_221 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1484 && _loc2_ < this.var_221.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_538,this.var_221[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_221 != null && this.var_221.length > 0)
         {
            ...
            this.var_371 = this.var_221[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_538,this.var_371),this.getRaceLocalizationKey(this.var_538,this.var_371));
            }
         }
         return this.getRaceLocalizationKey(this.var_538,this.var_371);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_371 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_538;
         var _loc3_:int = this.var_371;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_371 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
