package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1712:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_1711:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_143:Dictionary = new Dictionary();
      
      private static const const_1157:Object = {"frontpage3":[7,8]};
      
      private static const const_1156:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      
      {
         const_143["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_143["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_143["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_143["collectibles"] = ["ctlg_collectibles_link"];
         const_143["club1"] = ["ctlg_text_5"];
         const_143["club_buy"] = ["club_link"];
         const_143["mad_money"] = ["ctlg_madmoney_button"];
         const_143["monkey"] = ["ctlg_teaserimg_1_region","ctlg_special_img_region"];
      }
      ...
      {
         if(param1 < this.var_887.length)
         {
            return this.var_887[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_887.length)
         {
            _loc2_ = String(this.var_887[param1]).replace("#","0x");
