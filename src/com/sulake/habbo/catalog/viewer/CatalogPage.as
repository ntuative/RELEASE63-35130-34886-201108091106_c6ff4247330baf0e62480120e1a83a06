package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2102:String = "ctlg_";
      ...
      private var var_1331:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1330);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1330);
      }
      ...
      {
         var _loc2_:String = const_2102 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1993:
               if(this.var_1331 == null)
               {
                  this.var_1331 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1331);
               }
               break;
            case CatalogWidgetEnum.const_1938:
               this.var_38.push(new ItemGroupCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1929:
               this.var_38.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_2070:
               this.var_38.push(new SongDiskProductViewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_2045:
               this.var_38.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1973:
            ...
            case CatalogWidgetEnum.const_1888:
               ...
               break;
            case CatalogWidgetEnum.const_2085:
            ...
            case CatalogWidgetEnum.const_1849:
               ...
               break;
            case CatalogWidgetEnum.const_1875:
