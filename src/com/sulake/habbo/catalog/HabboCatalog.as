package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_724:uint = 1;
      ...
      private var var_226:CatalogViewer;
      
      private var var_256:ICatalogNavigator;
      
      private var var_115:Purse;
      
      private var var_107:RecyclerLogic;
      
      private var var_158:IMarketPlace;
      ...
      private var var_2793:GiftWrappingConfiguration;
      
      private var var_1324:ClubGiftController;
      
      private var var_578:ClubBuyController;
      
      private var var_862:ClubExtendController;
      
      private var var_861:Map;
      
      private var var_1325:Boolean = false;
      
      private var var_859:IPurchasableOffer;
      
      private var var_1626:IDragAndDropDoneReceiver;
      ...
      private var var_701:RoomPreviewer;
      
      private const const_2115:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_2069);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_404.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_578.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2794 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_404.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_153,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this._configuration != null && this._configuration.getKey("catalog.furniture.animation","CfhChatlogMessageParser") == "true")
         {
            if(this.var_701 == null)
            {
               this.var_701 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_907 || !this.var_256 || !this.var_256.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1076 = -1;
            this.var_860 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_256.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this._configuration.getKey("client.credits.embed.enabled","CfhChatlogMessageParser") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_404.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_404.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_404.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_861.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_226.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_256 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_226 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_226.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_724) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2115;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_270,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               this.var_2072 = param1.session.isPrivateRoom;
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_158 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1324 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_578 == null)
         {
            this.var_578 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_862 == null)
         {
            this.var_862 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_226 != null)
         {
            this.var_226.catalogWindowClosed();
         }
         if(this.var_107 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_107.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1627 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_256.buildCatalogIndex(_loc2_);
         if(this.var_860 && this.var_860 != "")
         {
            this.var_256.openPage(this.var_860);
            this.var_860 = "";
            this.var_1076 = -1;
         }
         else if(this.var_1076 > -1)
         {
            this.var_256.openPageById(this.var_1076,this.var_2073);
            this.var_1076 = -1;
            this.var_2073 = -1;
            this.var_860 = "";
         }
         else if(this.var_1627 && this.var_2794)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_256.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_2017));
         }
         else
         {
            this.var_256.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_226.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_226 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_226.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2795 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1198);
         }
         this.var_2795 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_134,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2792 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1272);
         }
         this.var_2792 = false;
         if(this._chargeConfirmationDialog != null && !this._chargeConfirmationDialog.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_333,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_886)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_352,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_333,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_352,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1428 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1324.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_158 != null)
         {
            this.var_158.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_158 != null)
         {
            this.var_158.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_158 != null)
         {
            this.var_158.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2793 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_158.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_861.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_861.add(_loc2_.productCode,_loc3_.slice());
            this.var_226.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1247 || !this.var_1247.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_223);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_209);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1325 && param1.type == RoomEngineObjectEvent.const_153)
         {
            this.resetPlacedOfferData(true);
            if(this.var_859 == null || this.var_859.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_859.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_859);
            _loc5_ = this.var_1626;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_373,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_66)
         {
            if(this.var_66.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_66 != null && this.var_66.productClassId == param1.classId)
         {
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc3_ = this.var_66.category;
               _loc4_ = this.var_66.wallLocation;
               _loc5_ = this.var_66.x;
               _loc6_ = this.var_66.y;
               _loc7_ = this.var_66.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_367:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_209);
                     if(this.var_66.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_385:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_223);
                     if(this.var_66.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_374:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
                     if(this.var_66.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_724);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_701 != null)
         {
            this.var_701.updatePreviewRoomView();
         }
      }
   }
}
