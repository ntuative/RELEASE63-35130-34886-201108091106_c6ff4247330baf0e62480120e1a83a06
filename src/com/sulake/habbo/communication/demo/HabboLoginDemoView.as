package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_904:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_132.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_188,HabboWindowStyle.const_46,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2121,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_132.habboConfiguration.getKey("use.sso","CfhChatlogMessageParser") == "true")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_132.habboConfiguration && this.var_132.habboConfiguration.getKey("try.existing.session","CfhChatlogMessageParser") == "true")
         {
            this.var_1533 = true;
            this._window.visible = false;
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_173,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2121,"/");
         ...
         {
            dispatchEvent(new Event(const_904));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_153.removeEventListener(SSOTicket.const_442,this.onParsedTicketSuccess);
            this.var_153.removeEventListener(SSOTicket.const_343,this.onParsedTicketFailure);
            this.var_153 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_153 = new SSOTicket(this.var_132.assets,_loc3_,_loc2_,param1);
         this.var_153.addEventListener(SSOTicket.const_442,this.onParsedTicketSuccess);
         this.var_153.addEventListener(SSOTicket.const_343,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_132.flashClientUrl = this.var_153.flashClientUrl;
         this.var_132.ssoTicket = this.var_153.ticket;
         this.var_153.removeEventListener(SSOTicket.const_442,this.onParsedTicketSuccess);
         this.var_153.removeEventListener(SSOTicket.const_343,this.onParsedTicketFailure);
         this.var_153 = null;
         dispatchEvent(new Event(const_904));
