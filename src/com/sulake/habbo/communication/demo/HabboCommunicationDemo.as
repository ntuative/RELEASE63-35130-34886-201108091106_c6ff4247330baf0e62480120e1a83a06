package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_67:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_15:IRoomSessionManager;
      
      private var var_612:IKeyExchange;
      
      private var var_1152:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_3043:PseudoRandom;
      ...
      private var var_263:HabboHotelView;
      
      private var var_1716:String = "";
      
      private const const_2121:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_756 = param1;
            this.var_67.initConnection(HabboConnectionType.const_269);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_67 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_67.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_67.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_67.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_67.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_67.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_67.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_67.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_67.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_67.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_67.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_67.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_67.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_67.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_67 && this.var_164 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_164.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_263 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_164.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_164.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_263.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_164.getKey("use.sso.ticket") == "1";
         this.var_756 = this.var_164.getKey("sso.ticket",null);
         this.var_2216 = this.var_164.getKey("flash.client.url","");
         this.var_3044 = this.var_164.getKey("external.variables.txt","");
         if(this.var_263 == null)
         {
            this.var_263 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_67.mode = HabboConnectionType.const_100;
            if(this.var_756)
            {
               this.var_67.initConnection(HabboConnectionType.const_269);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_904,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1955);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_67.mode = HabboConnectionType.const_100;
            if(this.var_164.keyExists("local.environment"))
            {
               this.var_67.mode = HabboConnectionType.const_1391;
            }
         }
         this.var_67.initConnection(HabboConnectionType.const_269);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_67.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_763);
            _loc3_ = new InitCryptoMessageComposer(this.var_67.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_3043 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_67.mode)
         {
            case HabboConnectionType.const_100:
               _loc6_ = "";
               _loc6_ = this.var_164.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_164.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1716 = _loc4_;
               this.var_263.loadBannerImage(_loc7_ + "?token=" + this.var_1716,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1391:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1803:
               this.var_1152 = this.generateRandomHexString(30);
               this.var_612 = new DiffieHellman(new BigInteger(this.var_164.getKey("connection.development.prime"),16),new BigInteger(this.var_164.getKey("connection.development.generator"),16));
               this.var_612.init(this.var_1152);
               _loc8_ = this.var_612.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_67.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_612.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_612.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_3043);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1717 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_305);
         connection.send(new VersionCheckMessageComposer(401,this.var_2216,this.var_3044));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2121,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_756 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_756);
            _loc2_.send(_loc4_);
      ...
      {
         var _loc4_:IConnection = this.var_67.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_285);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_3045)
         {
            _loc2_ = this.var_164.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_3045 = true;
         var _loc2_:String = this.var_164.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_164.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1716);
         ...
         var _loc9_:IConnection = this.var_67.getHabboMainConnection(null);
         ...
         this.var_612 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_612.init(_loc14_);
            _loc15_ = this.var_612.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1152 = _loc14_;
            }
