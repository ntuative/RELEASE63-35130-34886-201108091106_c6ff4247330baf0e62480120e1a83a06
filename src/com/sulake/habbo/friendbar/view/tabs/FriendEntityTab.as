package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1706:String = "entity_xml";
      
      private static const const_1705:String = "facebook_piece_xml";
      
      private static const const_1708:String = "controls_piece_xml";
      
      protected static const const_1053:String = "pieces";
      
      protected static const const_389:String = "icons";
      
      protected static const const_473:String = "header";
      
      protected static const const_1451:String = "facebook";
      
      protected static const const_1450:String = "controls";
      
      protected static const const_321:String = "canvas";
      
      protected static const const_704:String = "name";
      
      protected static const const_1171:String = "btn_message";
      
      protected static const const_1052:String = "icon_message";
      
      protected static const const_1452:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1047:String = "label";
      
      protected static const const_506:String = "notification";
      
      private static const const_73:uint = 10338138;
      
      private static const const_1069:uint = 13891476;
      
      private static const const_1154:String = null;
      
      private static const const_730:String = "icon_tag_notify";
      
      private static const const_1707:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_494:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1053));
         _loc3_ = _loc2_.getListItemByName(const_1451) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1450) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_506,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1053));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               ...
               _loc3_.name = const_1451;
               _loc6_ = _loc3_.getChildByName(const_704) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2254.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1708).content as XML) as IWindowContainer;
               _loc3_.name = const_1450;
               _loc8_ = _loc3_.getChildByName(const_1171);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1452);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1053)).getListItemByName(const_473) as IWindowContainer;
            _loc1_.findChildByName(const_704).caption = this.var_168.name;
            var_2254.crop(_loc1_.getChildByName(const_704) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_321));
      ...
      {
         var _loc1_:IWindowContainer = false ? const_494.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1706).content as XML) as IWindowContainer;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_494.indexOf(param1) == -1)
            {
               const_494.push(param1);
            }
         }
      }
         ...
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               ...
               case const_1052:
                  ...
                  if(var_356 && this.var_168)
                  {
                     var_356.startConversation(this.var_168.id);
                     this.deselect(true);
                     if(param1.window.name == const_1052)
                     {
               ...
               case const_1452:
                  if(var_356 && this.var_168)
                  {
                     var_356.followToRoom(this.var_168.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1154;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1401:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               ...
               _loc5_ = const_730;
               break;
            case FriendNotification.const_1288:
            ...
            case FriendNotification.const_400:
               ...
               _loc4_.iconElement.name = const_1052;
         ...
         if(_loc4_)
         {
            ...
            {
               _loc7_ = IItemListWindow(_window.findChildByName(const_389));
