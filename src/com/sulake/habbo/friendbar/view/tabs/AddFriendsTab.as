package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1691:String = "add_friends_tab_xml";
      
      private static const const_1692:String = "find_friends_icon_png";
      
      private static var var_1083:int = -1;
      
      private static const const_73:uint = 6907230;
      
      private static const const_1069:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_492:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_492.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1691).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_473));
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_492.indexOf(param1) == -1)
            {
               const_492.push(param1);
            }
         }
      }
