package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_1488:int = 13;
      
      private static const const_1070:int = 14;
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_84)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_795 = _loc5_.content as BitmapData;
                     if(this.var_795)
                     {
                        this.var_84.bitmap = this.var_795.clone();
                     }
                  }
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_639 = new Timer(15000);
            this.var_639.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_639.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_1820 = this._view.width - 7 - this.var_84.bitmap.width;
         this.var_1502 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_632 = new Timer(25,26);
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_84.x = 3 + this.var_1502 / 20 * this.var_1820;
         if(this.var_84.x > this.var_1820)
         {
            _loc2_ = this._view.width - 4 - this.var_84.x;
            _loc3_ = new BitmapData(_loc2_,this.var_795.height);
            _loc3_.copyPixels(this.var_795,new Rectangle(0,0,_loc2_,this.var_795.height),new Point(0,0));
