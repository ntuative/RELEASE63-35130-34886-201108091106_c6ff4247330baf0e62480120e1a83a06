package com.sulake.habbo.toolbar.extensions
{
   ...
   public class VideoOfferExtension
   {
      ...
      private static const const_693:String = "video_offer";
      
      private static const const_1111:String = "supersaverAdsOnCampaignsReady";
      
      private static const const_1112:String = "supersaverAdsOnCampaignCompleted";
      
      private static const const_1110:String = "supersaverAdsOnCampaignOpen";
      
      private static const const_1109:String = "supersaverAdsOnCampaignClose";
      
      private static const const_1597:String = "supersaverAdsLoadCampaigns";
      
      private static const const_1596:String = "supersaverAdsCamapaignEngage";
      
      private static const const_1487:uint = 16777215;
      
      private static const const_1489:uint = 12247545;
      
      private static const const_1595:uint = 6710886;
      
      private static const const_1594:uint = 13421772;
       
      
      private var var_829:HabboToolbar;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         ...
         {
            this._extensionView.detachExtension(const_693);
            this.destroyWindow();
            return;
         }
         if(false && !this.var_1954 && !this._view)
         {
            ExternalInterface.addCallback(const_1111,this.onCampaignsReady);
            ExternalInterface.addCallback(const_1112,this.onCampaignComplete);
            ExternalInterface.addCallback(const_1110,this.onCampaignOpen);
            ExternalInterface.addCallback(const_1109,this.onCampaignClose);
            ExternalInterface.call(const_1597);
         }
      }
      ...
      {
         this.var_1271 = parseInt(param1);
         if(isNaN(this.var_1271))
         {
            this.var_1271 = 0;
         }
         if(this.var_1271 <= 0 || this.var_1954 || this.var_12.clubIsExpiring && this.isClubExtensionEnabled())
         {
            if(this._view)
            {
               this.destroyWindow();
         ...
         if(!this._view)
         {
            ...
            if(this._view)
            {
               this._extensionView.attachExtension(const_693,this._view,ExtensionFixedSlotsEnum.const_1237);
            }
         }
      }
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_253)
               {
                  ...
                  this.var_253.addEventListener(WindowMouseEvent.const_25,this.method_7);
               }
            }
         }
         return _loc3_;
      ...
      private function destroyWindow() : void
      {
         if(this._view)
         {
            ...
            if(this.var_253)
            {
               ...
               this.var_253.removeEventListener(WindowMouseEvent.const_25,this.method_7);
               this.var_253 = null;
            }
            this._view.dispose();
            this._view = null;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(false)
            {
               ExternalInterface.addCallback(const_1111,null);
               ExternalInterface.addCallback(const_1112,null);
               ExternalInterface.addCallback(const_1110,null);
               ExternalInterface.addCallback(const_1109,null);
            }
            if(this.var_12)
            {
      ...
      private function onTextRegionClicked(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.var_1955 += 1;
            ExternalInterface.call(const_1596);
            this.turnVolumeDown();
            if(this._connection)
            {
         ...
         if(this.var_1271 == this.var_1955)
         {
            this.destroyWindow();
         }
      }
      ...
      private function onTextRegionMouseOut(param1:WindowMouseEvent) : void
      {
         ...
         {
            _loc2_ = this._view.findChildByName("promo_text") as ITextWindow;
            _loc2_.textColor = const_1487;
         }
      }
      
      private function turnVolumeDown() : void
      {
         if(this.var_829.soundManager)
         {
            this.var_1059 = this.var_829.soundManager.volume;
            this.var_829.soundManager.volume = 0;
         }
      }
      
      private function turnVolumeUp() : void
      {
         if(this.var_829.soundManager && this.var_1059 != -1)
         {
            this.var_829.soundManager.volume = this.var_1059;
         }
      }
   }
}
