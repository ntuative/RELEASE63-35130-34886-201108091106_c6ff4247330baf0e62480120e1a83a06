package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_479:Array = ["icon_shell_0_png","icon_shell_1_png","icon_shell_2_png","icon_shell_3_png"];
       
      
      private const const_1608:uint = 4.283212437E9;
      
      private const const_1609:uint = 4.282748017E9;
      ...
      public function ShellsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.bgColorLight = this.const_1608;
         this.bgColorDark = this.const_1609;
         this.textElementName = "amount";
         this.textElementShadowName = "amount_shadow";
         this.iconAnimationSequence = const_479.concat(const_479).concat(const_479);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.shells.zero.amount.text","Info");
         createWindow("purse_indicator_shells_xml",const_479[0]);
         this.setAmount(0);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_352,this.onShellBalance);
      }
      
      override protected function onContainerClick(param1:WindowMouseEvent) : void
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1784,true);
      }
      ...
      private function onShellBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1875 != 0)
         {
            if(this.var_1875 > param1.balance)
            {
