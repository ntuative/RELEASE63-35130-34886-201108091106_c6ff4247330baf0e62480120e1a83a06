package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1675:uint = 16777215;
      
      private static const const_1673:uint = 12247545;
      
      private static const const_1674:String = "HELP";
      ...
      {
         this.var_63.removeListItem(this.var_422);
      }
      
      public function showRoomInfo() : void
      {
         this.var_63.addListItemAt(this.var_422,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_338)
         {
            this.var_338 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_338.x = _loc1_.x + this._window.width - this.var_338.width;
            this.var_338.y = _loc1_.y + this._window.height - this.var_338.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this.var_412.toggleWindowVisibility(const_1674);
               break;
            case "roominfo_region":
               this.var_412.toggleWindowVisibility(MENU_ROOMINFO);
               break;
            case "confirm":
               if(false)
               {
