package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1555:String = "purse";
      
      private static const const_1556:String = "extra_tools";
      ...
      private var var_653:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1253:PurseExtension;
      
      private var var_1538:ClubDiscountPromoExtension;
      
      private var var_1539:VideoOfferExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_280.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_280 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog && this._soundManager)
         {
            this.var_280.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","CfhChatlogMessageParser") == "true")
         {
            this._extensionView = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this._extensionView)
            {
               this.var_1253 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_653 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               ...
               {
                  this.var_1538 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               if(this._config.getBoolean("supersaverads.video.promo.enabled",false))
               {
                  this.var_1539 = new VideoOfferExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this._extensionView.attachExtension(const_1555,this.var_1253.window,ExtensionFixedSlotsEnum.const_1944);
               this._extensionView.attachExtension(const_1556,this.var_653.window,ExtensionFixedSlotsEnum.const_1894);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_653.showRoomInfo();
         }
         else
         {
            this.var_653.hideRoomInfo();
         }
      }
