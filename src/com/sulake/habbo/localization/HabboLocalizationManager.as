package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1922:Dictionary;
      ...
      {
         this.var_1922 = new Dictionary();
         this.var_2608 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1923 = (param2 & 0) > 0;
         if(!this.var_1923)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1923)
            {
               if("CfhChatlogMessageParser" == this._configuration.getKey("use.default.localizations","CfhChatlogMessageParser"))
               {
                  _loc5_ = this._configuration.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_199,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_199,this.onLocalizationLoaded);
         if(this._configuration.keyExists("external.override.texts.txt"))
         {
            ...
            events.addEventListener(LocalizationEvent.const_199,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_199,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1922[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1922[param1];
      }
      ...
      {
         return this.var_2608[Math.max(0,param1 - 1)];
      }
