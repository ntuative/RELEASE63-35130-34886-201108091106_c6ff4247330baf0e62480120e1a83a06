package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1162:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1723:String = "sendAccessTokenToServer";
      
      private static const const_1722:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1723,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1722,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1162);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1162);
         }
      }
