package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      private function onFavoriteMembershipUpdate(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionUserDataUpdateEvent(_loc3_));
      }
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_133,_loc3_,_loc2_.userName));
      }
