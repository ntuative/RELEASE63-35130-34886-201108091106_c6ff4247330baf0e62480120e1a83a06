package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      {
         this.var_33.send(new GetIgnoredUsersMessageComposer(this.var_33.userName));
      }
      ...
      public function ignoreUser(param1:String) : void
      {
         ...
         this.var_33.send(new IgnoreUserMessageComposer(param1));
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1498.push(param1);
         this.var_33.send(new UnignoreUserMessageComposer(param1));
      }
