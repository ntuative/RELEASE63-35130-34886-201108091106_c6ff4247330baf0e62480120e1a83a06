package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3102:Array;
      
      private var var_2324:Boolean;
      
      private var var_2323:Boolean;
      
      private var var_1425:Dictionary;
      ...
      private var var_1757:UserTagManager;
      
      private var var_970:BadgeImageManager;
      
      private var var_1756:HabboGroupInfoManager;
      
      private var var_971:IgnoredUsersManager;
      ...
      private var var_1184:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3102 = [];
         this.var_1757 = new UserTagManager(events);
         this.var_1756 = new HabboGroupInfoManager(this,events);
         this.var_971 = new IgnoredUsersManager(this);
         this.var_1184 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_629)
         {
            this.var_629.removeEventListener(ProductDataParser.const_123,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_970 = new BadgeImageManager(assets,events,this._configuration,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1757.communication = this._communication;
         this.var_1756.communication = this._communication;
         this.var_1184.communication = this._communication;
         this.var_971.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_318)
         {
            ...
            this.var_318 = new FurnitureDataParser(this.var_529,this._wallItems,this.var_528,this._localization);
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2755 = _loc3_.respectTotal;
         this.var_1183 = _loc3_.respectLeft;
         this.var_776 = _loc3_.petRespectLeft;
         this.var_630 = _loc3_.figure;
         this.var_975 = _loc3_.sex;
         this._realName = _loc3_.realName;
         this.var_971.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_630 = _loc2_.figure;
            this.var_975 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_630,this.var_975));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2324 = _loc2_.isOpen;
         this.var_2323 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1754 >= SecurityLevelEnum.const_1332;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1757.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_970.getBadgeImage(param1);
      }
      
      public function requestBadgeImage(param1:String) : BitmapData
      {
         return this.var_970.getBadgeImage(param1,BadgeImageManager.const_1276,false);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_970.getBadgeImageWithInfo(param1);
      }
      
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(this._configuration.getKey("groupBadgeInfo.enabled") == "CfhChatlogMessageParser")
         {
         ...
         this.send(new EventLogMessageComposer(GroupDetailsView.const_211,"" + param1,"badge clicked"));
      }
      ...
      {
         return this.var_1756.getBadgeId(param1);
      }
      ...
      {
         return this.var_970.getBadgeImage(param1,BadgeImageManager.const_1240);
      }
      ...
      {
         return this.var_971.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_971.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_971.unignoreUser(param1);
      }
      ...
      {
         if(param1 < 0 || this.var_1183 < 1)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         this.send(new RespectUserMessageComposer(param1));
         this.var_1183 = this.var_1183 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         if(param1 < 0 || this.var_776 < 1)
         {
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1185.indexOf(param1) == -1)
         {
         ...
         if(this.var_629 == null)
         {
            ...
            this.var_629 = new ProductDataParser(_loc2_,this.var_1425);
            this.var_629.addEventListener(ProductDataParser.const_123,this.onProductsReady);
         }
         return false;
      }
