package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private var var_1377:GroupDetailsView;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(this.var_245.getValue(_loc4_) != null)
            {
               this.var_245.remove(_loc4_);
            }
            this.var_245.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      private function onJoinFailed(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_89.localization.getKey(_loc3_,_loc3_);
         this.var_89.windowManager.alert("${group.joinfail.title}",_loc4_,0,this.onAlertClose);
      }
      ...
      private function getGroupDetailsView() : GroupDetailsView
      {
         if(this.var_1377 == null)
         {
            this.var_1377 = new GroupDetailsView(this.var_89);
         }
      ...
      {
         return this.var_245.getValue(param1);
      }
