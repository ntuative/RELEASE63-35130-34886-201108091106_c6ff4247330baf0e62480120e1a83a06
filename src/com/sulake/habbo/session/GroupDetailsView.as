package com.sulake.habbo.session
{
   ...
   public class GroupDetailsView
   {
      ...
      public static const const_211:String = "HabboGroups";
       
      
      private var var_89:SessionDataManager;
      
      private var _window:IWindowContainer;
      
      private var var_63:IItemListWindow;
      
      private var var_494:HabboGroupDetailsData;
      ...
      public function GroupDetailsView(param1:SessionDataManager)
      {
         ...
         this.var_89.events.addEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImageReady);
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this._window != null && this.var_494 != null && param1.badgeId == this.var_494.badgeCode)
         {
            this.refreshBadgeImage();
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_63.numListItems)
         {
            _loc3_ = IWindowContainer(this.var_63.getListItemAt(_loc2_));
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_89.getXmlWindow("group_info"));
         ...
         this._window.findChildByName("join_button").procedure = this.method_10;
         this._window.findChildByName("my_groups_region").procedure = this.onMyGroups;
         this.var_63 = IItemListWindow(this._window.findChildByName("groups_item_list"));
         this._window.center();
      }
      ...
      {
         this.prepareWindow();
         this._window.caption = this.var_89.localization.getKey(param2,param2);
      ...
      {
         var _loc2_:IRegionWindow = IRegionWindow(this.var_89.getXmlWindow("group_entry"));
      ...
      private function setImageButton(param1:IRegionWindow, param2:String, param3:Function, param4:String) : void
      {
         ...
         _loc6_.bitmap = this.var_89.getButtonImage(param4);
      }
      ...
      public function onGroupDetails(param1:HabboGroupDetailsData) : void
      {
         ...
         this._window.findChildByName("join_button").visible = param1.status == HabboGroupDetailsData.const_1845;
         this._window.findChildByName("membership_pending_txt").visible = param1.status == HabboGroupDetailsData.const_1989;
         this.var_89.windowManager.registerLocalizationParameter("group.membercount","totalMembers","" + param1.totalMembers);
         this._window.findChildByName("group_room_link_region").visible = param1.roomId > -1;
         this.var_89.windowManager.registerLocalizationParameter("group.room.link","room_name",param1.roomName);
         this.refreshBadgeImage();
      ...
      private function refreshBadgeImage() : void
      {
         ...
         var _loc2_:BitmapData = this.var_89.getGroupBadgeImage(this.var_494.badgeCode);
         _loc1_.bitmap.fillRect(_loc1_.bitmap.rect,16777215);
         if(_loc2_ != null)
         {
            _loc1_.bitmap.draw(_loc2_,this.var_1410);
      ...
      private function refreshEntryBadgeImage(param1:IWindowContainer, param2:HabboGroupEntryData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_89.getGroupBadgeImage(param2.badgeCode);
      ...
      private function onMyGroups(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.send(new GetHabboGroupsWhereMemberMessageComposer());
         this.var_89.send(new EventLogMessageComposer(const_211,"","my groups"));
      }
      ...
      private function onSelectGroup(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.showGroupBadgeInfo(param2.id);
         this.var_89.send(new EventLogMessageComposer(const_211,"" + param2.id,"select"));
      }
      ...
      private function method_10(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.send(new JoinHabboGroupMessageComposer(this.var_494.groupId));
         this.var_89.send(new EventLogMessageComposer(const_211,"" + this.var_494.groupId,"join"));
      }
      ...
      private function onMakeFavourite(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.send(new SelectFavouriteHabboGroupMessageComposer(param2.parent.id));
         this.var_89.send(new EventLogMessageComposer(const_211,"" + param2.parent.id,"make favourite"));
      }
      ...
      private function onClearFavourite(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.send(new DeselectFavouriteHabboGroupMessageComposer(param2.parent.id));
         this.var_89.send(new EventLogMessageComposer(const_211,"" + param2.parent.id,"clear favourite"));
      }
      ...
      private function onHomepageLink(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_89.configuration.getKey("group.homepage.url","http://%predefined%/groups/%groupid%/id");
         _loc3_ = _loc3_.replace("%groupid%",this.var_494.groupId);
         this.openExternalLink(_loc3_);
         this.var_89.send(new EventLogMessageComposer(const_211,"" + this.var_494.groupId,"homepage"));
      }
      ...
      private function onRoomLink(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_89.roomSessionManager.gotoRoom(false,this.var_494.roomId);
         this.close();
         this.var_89.send(new EventLogMessageComposer(const_211,"" + this.var_494.groupId,"base"));
      }
      ...
      private function openExternalLink(param1:String) : void
      {
         if(param1 != "")
         {
            this.var_89.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
