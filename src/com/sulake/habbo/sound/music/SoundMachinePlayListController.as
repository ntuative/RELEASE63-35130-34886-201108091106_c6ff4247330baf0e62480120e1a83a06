package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_249:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_766,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_869,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_766,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_869,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_493);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_249.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_493 = -1;
         this.var_712 = false;
         this.var_249.stop(HabboMusicPrioritiesEnum.const_127);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_249.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_249.playSong(param1,HabboMusicPrioritiesEnum.const_127,_loc3_,0,0,0))
         {
