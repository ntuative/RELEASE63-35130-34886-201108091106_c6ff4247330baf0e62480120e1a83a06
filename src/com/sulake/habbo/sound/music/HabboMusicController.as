package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1738:int = HabboMusicPrioritiesEnum.const_127;
      ...
      private var var_749:Map;
      
      private var var_927:Array;
      
      private var var_607:IPlayListController = null;
      ...
      private var var_3003:int = -1;
      
      private var var_3002:int = -1;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_749 = new Map();
         this.var_927 = new Array();
         this.var_351 = [];
         this.var_925 = [];
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_758,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_287,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_928,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_768,this.onSoundMachineDispose);
         this.var_1408 = new Timer(1000);
         this.var_1408.start();
         this.var_1408.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_276)
         {
            this.var_351[_loc6_] = null;
            this.var_925[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2202)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_138,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_308.length)
               {
                  _loc3_ = this.var_308.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_758,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_287,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_928,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_768,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_351[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_351[param1];
      ...
      {
         var _loc1_:int = this.var_351.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_351[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_308.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_276)
         {
      ...
      {
         if(this.var_749.getValue(param1) == null)
         {
            this.var_749.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_308.length)
         {
            ...
            if(_loc3_.id != this.var_1702 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         var _loc1_:* = [];
         var _loc2_:int = 0;
         while(_loc2_ < this.var_351.length)
         {
            if(this.var_351[_loc2_] != null)
            {
               _loc3_ = this.var_351[_loc2_];
               _loc4_ = this.var_308.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_927));
         Logger.log("Requested song info\'s : " + this.var_927);
         this.var_927 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_308.add(_loc6_.id,_loc10_);
               ...
               while(this.var_926.indexOf(_loc6_.id) != -1)
               {
                  this.var_926.splice(this.var_926.indexOf(_loc6_.id),1);
                  if(this.var_926.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_276)
         {
            return false;
         }
         ...
         this.var_2202 = this.getSongRequestCountAtPriority(param1);
         this.var_1702 = param2;
         if(this._priorityPlaying <= const_1738)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_127)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_142,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_3003 != param1.id || _loc3_ > this.var_3002 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_3003 = param1.id;
            this.var_3002 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_749.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_424.add(_loc5_,_loc6_);
            if(this.var_308.getValue(_loc6_) == null)
            {
               this.var_926.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_607 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_607 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
