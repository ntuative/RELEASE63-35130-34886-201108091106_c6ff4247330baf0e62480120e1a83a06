package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1188:int = 60;
      
      private static const const_1189:int = 3600;
      
      private static const const_1190:int = 86400;
      
      private static const const_1187:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_35 = param2;
         this.var_1471 = param3;
         this.var_1423 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_1188)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1189)
         {
            return Math.round(param1 / const_1188) + " mins ago";
         }
         if(param1 < 2 * const_1190)
         {
            return Math.round(param1 / const_1189) + " hours ago";
         }
         if(param1 < 2 * const_1187)
         {
            return Math.round(param1 / const_1190) + " days ago";
         }
         return Math.round(param1 / const_1187) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1424.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1424.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1426,this._data.userId),this._callerFrame,this.var_1423,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1423,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1471),this._callerFrame,this.var_1423,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1471),this._callerFrame,this.var_1423,false,true);
      }
