package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1069:ICheckBoxWindow;
      
      private var var_1615:ICheckBoxWindow;
      
      private var var_1616:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_372));
         Logger.log("BEGINNING TO SHOW: " + this.var_372);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1999;
      }
      ...
      {
         this.var_63 = IItemListWindow(this._frame.findChildByName("list_cont"));
         ...
         this.var_1069 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1615 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1616 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_63.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_63,_loc3_);
            this.disposeItemFromList(this.var_63,this.var_63.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_895,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1069.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_2032,_loc2_,this.var_532.text,"",""));
         if(this.var_1615.isSelected || this.var_1616.isSelected || this.var_1069.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1615.isSelected,this.var_1616.isSelected,this.var_1069.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2082);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_2081);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1197.selection];
         if(_loc3_ != null)
         {
            this.var_721 = false;
