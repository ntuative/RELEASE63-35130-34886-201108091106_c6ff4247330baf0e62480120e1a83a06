package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_978:OffenceCategoryData;
      
      private var var_979:OffenceData;
      
      private var var_1191:IButtonWindow;
      
      private var var_1190:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1191 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1190 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1769;
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_978 != null;
         if(this.var_979 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_979.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_978 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_978.offences,this.var_1191,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1190,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_2076;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1472,this.var_532.text,this.var_1471));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_978 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_979 = this.var_978.offences[_loc3_];
         this.var_532.text = this.var_979.msg;
         this.var_721 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1472,this.var_532.text,this.var_1471));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1472,this.var_532.text,this.getBanLength(),this.var_1471));
         this.dispose();
      }
