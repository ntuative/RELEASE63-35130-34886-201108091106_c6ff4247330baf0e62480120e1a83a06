package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1132:Array = [];
      
      private static var var_2176:int = 200;
      ...
      {
         this.var_914 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
         ...
         this.var_63 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1132.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_914.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1132.length < var_2176)
         {
            ...
            param1.width = this.var_914.width;
            param1.height = this.var_914.height;
            var_1132.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_63.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_63.scrollableRegion.height > this.var_63.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_63.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1680)
         {
