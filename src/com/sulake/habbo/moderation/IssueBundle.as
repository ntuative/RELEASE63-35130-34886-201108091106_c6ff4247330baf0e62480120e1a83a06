package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_853:IssueMessageData = null;
      
      private var var_854:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2593 = param2.pickerUserId;
         this.var_2785 = param2.pickerUserName;
         this.var_1494 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1318 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1319;
         }
         if(this.var_853 == null || param1.timeStamp < this.var_853.timeStamp)
         {
            this.var_853 = param1;
         }
         if(this.var_854 == null || param1.priority > this.var_854.timeStamp)
         {
            this.var_854 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1318 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1319;
            }
            if(this.var_853 == _loc2_)
            {
               this.var_853 = null;
            }
            if(this.var_854 == _loc2_)
            {
               this.var_854 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_854;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_853;
         if(_loc2_ == null)
         {
