package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_595:UserInfoCtrl;
      
      private var var_1352:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_76.windowManager == null || this.var_76.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_76.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_76.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_76.disableButton(this.var_76.initMsg.chatlogsPermission,this._window,"show_chatlog");
         ...
         this.var_595 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_1352 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_595.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1352.load(_loc4_,this.var_185.reportedUserId);
         }
         else
         {
      ...
      private function updateIssueList() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_76.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_76.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_76.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_76.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_76 != null && this.var_76.issueManager != null && this.var_185 != null)
         {
            this.var_76.issueManager.removeHandler(this.var_185.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_185.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_185.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_185.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.releaseBundle(this.var_185.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_76,WindowTracker.const_1321,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_595 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
            this.var_595.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_76 == null || this.var_76.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_76.issueManager.autoPick();
         }
      }
   }
}
