package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1386:int = 2;
      ...
      private var var_1477:Function;
      
      private var var_983:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_984)
            {
               this.var_984.addChild(this._window);
            }
