package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1744:String = "pixelbalance";
      
      private static const const_1739:String = "badges";
      
      private static const const_1742:String = "selectbadge";
      
      private static const const_1743:String = "inventory";
      
      private static const const_1746:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1745:String = "friendlist";
      
      private static const const_1740:String = "pet_inventory";
      
      private static const const_1741:String = "go_to_room";
      ...
      private var var_829:IHabboToolbar;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_1409:Array;
      
      private var var_1145:Map;
      
      private var var_608:HabboNotificationViewManager;
      
      private var var_262:HabboAlertDialogManager;
      
      private var var_928:ParkBusDialogManager;
      
      private var var_3004:Boolean;
      
      private var var_1147:ClubGiftNotification;
      
      private var var_1144:ClubEndingNotification;
      
      private var var_1146:ClubPromoNotification;
      
      private var var_3131:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1409 = new Array();
         this.var_1145 = new Map();
         this.var_2028 = false;
         this.var_3131 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1145);
         }
         var _loc6_:Map = this.var_1145["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1145["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1409.push(_loc8_);
         return this.var_1409.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1409.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_262 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_829 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_608 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_829,this.var_1145["styles"],this.var_1145["view"]);
         ...
         registerUpdateReceiver(this.var_608,1);
         registerUpdateReceiver(this,2);
         this.var_404.events.addEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_404.userId == _loc2_.userId)
         {
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2060,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_795,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_74)
               {
                  _loc7_ = this.var_404.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_404.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_404.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_2042,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1404)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1146 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1144 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_608.isSpaceAvailable() && this.var_1409.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_608.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1740:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_126);
               }
               break;
            case const_1746:
               break;
      ...
      {
         if(param1 != null && this.var_608 != null)
         {
            this.var_608.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_385;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_374;
            }
            return 1;
         }
         return 1;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_262 == null)
         {
            return;
         }
         this.var_262.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_262.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_262.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_262.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_262.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_928 == null)
         {
            this.var_928 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_928 != null)
         {
            this.var_928.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1245,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1245,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_976.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_3004)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_795,null);
            this.var_3004 = true;
      ...
      {
         if(param2.type == WindowEvent.const_173 || param2.type == WindowEvent.const_526)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1147 && this.var_1147.visible)
         {
            return;
         }
         this.var_1147 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_829);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_795,_loc6_);
      }
   }
}
