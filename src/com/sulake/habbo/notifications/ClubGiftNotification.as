package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private var var_2193:ITextWindow;
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this.var_412.extensionView.attachExtension(const_687,this._window);
         this.var_2193 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this.var_412)
         {
            this.var_412.extensionView.detachExtension(const_687);
         }
         if(this._window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "open_catalog_button":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1848,true);
               }
               this.dispose();
               break;
      ...
      {
         this.var_2193.textColor = const_1489;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_2193.textColor = const_1487;
      }
