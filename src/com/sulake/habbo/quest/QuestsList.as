package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1554:int = 5;
      
      private static const const_1553:int = 10;
      
      private static const const_1552:int = 10;
      
      private static const const_1551:int = 30;
      ...
      private var var_1907:Boolean = true;
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1536.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1536[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_614 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_63.spacing = const_1553;
      }
      
      private function refreshEntry(param1:Boolean, param2:int, param3:QuestMessageData, param4:Boolean) : Boolean
      {
         var _loc5_:IWindowContainer = IWindowContainer(this.var_63.getListItemAt(param2));
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_63.addListItem(_loc5_);
            _loc6_ = true;
         }
         if(param1)
         {
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1552;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1554;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1551;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1907 && !this.var_1906)
            {
               this.var_1907 = false;
