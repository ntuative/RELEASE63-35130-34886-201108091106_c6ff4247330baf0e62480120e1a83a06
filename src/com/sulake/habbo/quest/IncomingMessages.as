package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_2182:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_50 = param1;
         this._communication = this.var_50.communication;
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_50.questController.onQuestCompleted(_loc2_.questData);
      }
      
      private function onQuestCancelled(param1:IMessageEvent) : void
      {
         Logger.log("Quest Cancelled: ");
         this.var_50.questController.onQuestCancelled();
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         this.var_50.questController.onQuests(_loc2_.quests,_loc2_.openWindow);
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         this.var_50.questController.onQuest(_loc2_.quest);
      }
      ...
      {
         this.var_50.questController.onRoomEnter();
         this.var_50.currentlyInRoom = true;
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_50.questController.onRoomExit();
         this.var_50.achievementController.onRoomExit();
         this.var_50.currentlyInRoom = false;
      }
      ...
      private function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this.var_50.achievementController.onAchievements(_loc3_.achievements,_loc3_.defaultCategory);
      }
      ...
      private function onAchievement(param1:IMessageEvent) : void
      {
         ...
         this.var_50.achievementController.onAchievement(_loc3_.achievement);
      }
      ...
      private function onAchievementsScore(param1:IMessageEvent) : void
      {
         ...
         this.var_50.localization.registerParameter("achievements.categories.score","score",_loc3_.score.toString());
      }
      ...
      private function onLevelUp(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_50.localization.getBadgeBaseName(_loc3_.data.badgeCode);
         this.var_50.send(new EventLogMessageComposer("Achievements",_loc4_,"Leveled","",_loc3_.data.level));
         this.var_50.achievementController.levelUpDialog.onLevelUp(_loc3_.data);
      }
      ...
      private function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         this.var_50.achievementController.levelUpDialog.requestFacebookPostDialog(_loc2_.badgeID,_loc2_.shareID);
      }
   }
}
