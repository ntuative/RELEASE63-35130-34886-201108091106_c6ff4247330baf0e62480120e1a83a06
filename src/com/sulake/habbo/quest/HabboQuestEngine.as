package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1721:int = 5;
      
      private static const const_1720:int = 800;
      
      private static const const_1718:int = 15;
      
      private static const const_1719:int = 300;
      ...
      private var var_1375:QuestController;
      
      private var var_733:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1375 = new QuestController(this);
         this.var_733 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1721);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_404.events.removeEventListener(BadgeImageReadyEvent.const_139,this.var_733.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_404.events.addEventListener(BadgeImageReadyEvent.const_139,this.var_733.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1375.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_733.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1375.questTracker.isVisible();
      }
