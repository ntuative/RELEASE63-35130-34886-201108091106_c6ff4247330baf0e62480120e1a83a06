package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_826:FaqCategory;
      
      private var var_827:FaqCategory;
      
      private var var_825:FaqCategory;
      ...
      {
         super();
         this.var_826 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_827 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_825 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_177 != null)
         {
            ...
            {
               _loc2_ = this.var_177.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_177.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(this.var_826.hasItem(param1))
         {
            this.var_826.getItem(param1).answerText = param2;
         }
         if(this.var_827.hasItem(param1))
         {
            this.var_827.getItem(param1).answerText = param2;
         }
         if(this.var_825.hasItem(param1))
         {
            this.var_825.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_177.length)
         {
            _loc4_ = this.var_177.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_826.hasItem(param1))
         {
            return this.var_826.getItem(param1);
         }
         if(this.var_827.hasItem(param1))
         {
            return this.var_827.getItem(param1);
         }
         if(this.var_825.hasItem(param1))
         {
            return this.var_825.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_177.length)
         {
            _loc3_ = this.var_177.getWithIndex(_loc2_);
