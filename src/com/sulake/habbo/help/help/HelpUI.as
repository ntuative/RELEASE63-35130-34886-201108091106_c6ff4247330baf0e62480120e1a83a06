package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2103:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201108091101));
         this.var_140 = new Map();
         this.var_140.add(HabboHelpViewEnum.const_2057,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_225,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_627,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_368,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_320,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_444,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_927,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_316,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_140.add(HabboHelpViewEnum.const_1263,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_140.add(HabboHelpViewEnum.const_1254,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_140.add(HabboHelpViewEnum.const_823,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_140.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_140.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_587.length == 0 || param1 != this.var_414)
            {
               this.var_587.push(this.var_414);
            }
         }
         this.var_414 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_414);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_316:
               this.showUI(HabboHelpViewEnum.const_316);
               break;
            case CallForHelpResultEnum.const_1327:
               this.showUI(HabboHelpViewEnum.const_1254);
               break;
            case CallForHelpResultEnum.const_1382:
               this.showUI(HabboHelpViewEnum.const_1263);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_140.getValue(HabboHelpViewEnum.const_225) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_630));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_140.length)
         {
            _loc3_ = this.var_140.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_140.getValue(this.var_414);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2670 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2668;
         this._window.width = _loc1_.width + this.var_2670;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_587.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_414 == HabboHelpViewEnum.const_225)
         {
            return;
         }
         if(this.var_710.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_710.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_710[1],this.var_710[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_710[0],this.var_710[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_414 == HabboHelpViewEnum.const_225 || this.var_587.length == 0)
         {
            return;
         }
         if(this.var_413 == null)
         {
            ...
            this.var_413 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_413.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_413.findChildByName("back_text");
            if(_loc4_ != null)
            {
