package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_856)
         {
            this.var_856 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_856)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_855)
         {
            this.var_855 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_855)
            {
               return;
            }
