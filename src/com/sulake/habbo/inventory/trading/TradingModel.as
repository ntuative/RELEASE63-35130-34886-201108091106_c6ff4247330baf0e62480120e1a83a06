package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1895:uint = 9;
      
      public static const const_221:uint = 0;
      
      public static const const_213:uint = 1;
      
      public static const const_416:uint = 2;
      
      public static const const_387:uint = 3;
      
      public static const const_634:uint = 4;
      
      public static const const_298:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_922);
      ...
      public function close() : void
      {
         if(this.var_809)
         {
            if(this._state != const_221 && this._state != const_298)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_921 + " OTHER: " + this.var_1402);
         ...
         {
            case const_221:
               if(param1 == const_213 || param1 == const_298)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1323);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_922)
            {
               this.var_921 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1402 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_922)
            {
               this.var_61.alertPopup(TradingView.const_1216);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_307.length < const_1895)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_224)
            {
