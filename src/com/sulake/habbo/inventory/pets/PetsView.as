package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2153:int = 0;
      
      private const const_1082:int = 1;
      
      private const const_1177:int = 2;
      ...
      {
         var _loc2_:PetsGridItem = this.var_600.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_600 == null || this.var_600.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_600.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_600.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_600.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         for each(_loc1_ in this.var_600)
         {
            _loc1_.dispose();
         }
         this.var_600.reset();
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_47)
         {
            ...
            {
               case "tab_floor":
                  this.var_78.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1082;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1177;
         }
         else
         {
            _loc2_ = this.const_1178;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1082:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1177:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1178:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
