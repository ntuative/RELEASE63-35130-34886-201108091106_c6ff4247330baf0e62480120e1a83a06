package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2395:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_62)
         {
            _loc1_ = this.var_62.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_62.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_504,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_62.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_62.getValue(InventorySubCategory.const_383));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_62.getValue(InventoryCategory.const_146));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_62.getValue(InventoryCategory.const_278));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_62.getValue(InventorySubCategory.const_1326));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_62.getValue(InventoryCategory.const_126));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_62.getValue(InventoryCategory.const_456) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1530 = new IncomingMessages(this);
      ...
      {
         this.var_404 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_504,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_81:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_504:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_404 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_412 || !this._soundManager)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_412);
         this.var_62 = new Map();
         ...
         this.var_62.add(InventoryCategory.const_456,_loc1_);
         ...
         this.var_62.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_404);
         this.var_62.add(InventoryCategory.const_278,_loc3_);
         ...
         this.var_62.add(InventoryCategory.const_146,_loc4_);
         ...
         this.var_62.add(InventorySubCategory.const_383,_loc5_);
         ...
         this.var_62.add(InventorySubCategory.const_1326,_loc6_);
         ...
         this.var_62.add(InventoryCategory.const_126,_loc7_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_62.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_62.length)
         {
            _loc3_ = this.var_62.getWithIndex(_loc2_) as IInventoryModel;
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_62.length)
         {
            _loc2_ = this.var_62.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1020.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1020.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1020.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1020.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_62.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2395);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_313));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2563)
         {
            this.var_2563 = _loc1_;
            this._view.updateUnseenItemCounts();
            this.var_412.setUnseenItemCount(HabboToolbarIconEnum.INVENTORY,_loc1_);
         }
      }
   }
}
