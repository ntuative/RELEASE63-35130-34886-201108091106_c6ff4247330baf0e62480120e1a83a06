package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1667:int = 100;
      
      private static const const_1668:int = 1000;
      ...
      private var var_1624:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_484 = [];
         this.var_485 = [];
         this.var_699 = new Timer(const_1667,1);
         this.var_699.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2789 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_153,this.onObjectPlaced);
               }
            ...
            {
               this.var_699.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_699.stop();
               this.var_699 = null;
            }
            if(this.var_225 != null)
            {
               this.var_225.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_225.stop();
               this.var_225 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1624 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1624;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_78);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_385)
         {
         ...
         else if(param3 == FurniCategory.const_374)
         {
         ...
         if(this.var_858 == null)
         {
            this.var_858 = this._windowManager.buildFromXML(this.var_2789) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_858.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_858.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_39,const_44];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_225 = new Timer(param1,1);
            this.var_225.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_225.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_78 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_288:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_126);
            }
         }
      }
      ...
      {
         this.var_2790 = getTimer();
         this.switchCategory(const_288);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_456);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_39,const_44];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_39,const_44];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_700.add(const_39,new Array());
         this.var_700.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_484.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_485.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_224)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_288)
            {
      ...
      {
         return getTimer() < this.var_2790 + const_1668;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_383;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_367 || _loc3_.category == FurniCategory.const_385 || _loc3_.category == FurniCategory.const_374)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_700.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_383:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_700.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_1007)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_484.indexOf(_loc2_) == -1)
            {
               this.var_484.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_485.indexOf(_loc2_) == -1)
            {
               this.var_485.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_463:
               return this.var_484.length;
            case UnseenItemCategoryEnum.const_440:
               return this.var_485.length;
            default:
               return this.var_484.length + this.var_485.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_485 && this.var_485.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_440));
                  this.var_485 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_39:
               if(this.var_484 && this.var_484.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_463));
                  this.var_484 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
