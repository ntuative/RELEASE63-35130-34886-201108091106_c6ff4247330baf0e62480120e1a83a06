package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2153:int = 0;
      
      private static const const_1082:int = 1;
      
      private static const const_1177:int = 2;
      
      private static const const_1178:int = 3;
      
      private static const const_1176:int = 42;
      
      private static const const_1179:int = 120;
      
      private static const const_1167:int = 4;
      ...
      private var var_803:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_232.add(FurniModelCategory.const_39,new FurniGridView(this.var_78,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_232.add(FurniModelCategory.const_44,new FurniGridView(this.var_78,FurniModelCategory.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1167;
            _loc3_.y = _loc4_.y + const_1167;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_232)
            {
               for each(_loc1_ in this.var_232)
               {
                  _loc1_.dispose();
               }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_232.getValue(this.var_510);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_78.getCategoryContent(this.var_510);
         ...
         if(this.var_1199 == _loc2_)
         {
            return;
         }
         this.var_1199 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_39,FurniModelCategory.const_44];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_232.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_232.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_232.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_232.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_440) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_78.getGroupItemInIndex(_loc3_,this.var_510);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_223);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_209);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_207);
            ...
            if(_loc5_.category == FurniCategory.const_385)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_374)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_803 && this.var_803.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1179)
         {
            _loc3_ = const_1179;
         }
         else if(_loc3_ < const_1176)
         {
            _loc3_ = const_1176;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_47)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_288);
            }
         }
      }
