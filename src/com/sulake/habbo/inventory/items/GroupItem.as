package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_948:int = 0;
      
      protected var var_758:BitmapData;
      
      protected var var_2963:int;
      
      protected var var_1726:Boolean;
      
      protected var var_2281:Boolean;
      
      protected var var_3080:BitmapData;
      
      private var var_1518:Boolean;
      
      private const const_2119:Number = 1;
      
      private const const_2118:Number = 0.2;
      ...
      private function method_6(param1:BitmapData) : void
      {
         this.var_758 = param1;
         this.var_1726 = true;
         this.var_948 = -1;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2280 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_2132));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2277);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
            ...
            this.var_948 = _loc2_.id;
         }
         else
         {
            this.method_6(_loc2_.data);
            this.var_948 = -1;
         }
         this.var_1726 = true;
      }
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_1007)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2118;
               _loc1_.blend = this.const_2118;
            }
            else
            {
               this._window.blend = this.const_2119;
               _loc1_.blend = this.const_2119;
            }
         }
         this.var_1590.color = !!this.var_1518 ? uint(const_1521) : uint(const_1520);
         this.var_2499.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2281 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3080;
               _loc5_.visible = true;
            }
            else
            {
