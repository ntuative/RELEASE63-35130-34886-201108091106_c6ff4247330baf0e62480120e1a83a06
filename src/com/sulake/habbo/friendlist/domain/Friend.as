package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2213:int = "F".charCodeAt(0);
      
      public static const const_2346:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_975 = param1.gender;
         this.var_837 = param1.online;
         this.var_2078 = param1.followingAllowed && param1.online;
         this.var_630 = param1.figure;
         this.var_1944 = param1.motto;
         this.var_1945 = param1.lastAccess;
