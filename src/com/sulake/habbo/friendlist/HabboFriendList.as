package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_912:ISessionDataManager;
      
      private var var_2944:FriendListLookAndFeel;
      
      private var var_505:FriendListTabs;
      ...
      private var var_123:FriendRequests;
      
      private var var_2170:AvatarSearchResults;
      ...
      {
         this.var_2944 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2170 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_735.stop();
            this.var_735.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_735 = null;
         }
         ...
         if(this.var_912)
         {
            this.var_912.release(new IIDSessionDataManager());
            this.var_912 = null;
         }
         super.dispose();
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_109);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_92);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_430);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_384,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_957.createAvatarImage(param1,AvatarScaleType.const_111,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_412 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_1138 = param2 as IHabboNotifications;
      ...
      {
         this.var_912 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_123 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_119.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1423,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_465,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_505 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_735)
         {
            this.var_735 = new Timer(120000);
            this.var_735.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_735.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_465);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_123.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_123.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_505.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_123.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_505.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2170.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_505.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_505.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_912 || !this.var_123)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_912.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_123.vipLimit;
         }
         else if(this.var_912.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_33))
         {
            _loc2_ = this.var_123.clubLimit;
         }
         if(_loc2_ > this.var_123.limit)
         {
            this.var_123.limit = _loc2_;
         }
      }
