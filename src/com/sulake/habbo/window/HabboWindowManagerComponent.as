package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1465:uint = 1;
      ...
      private var var_1463:IEventDispatcher;
      
      private var var_1186:Boolean = false;
      
      private var var_1763:ProfilerOutput;
      
      private var var_1465:ProfilerAgentTask;
      
      private var var_1464:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_211 = new Array(const_475);
         ...
         {
            this.var_211[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_724 = this.var_211[const_1465];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1763)
            {
               this.var_1763 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1763.profiler = _loc3_;
            this.var_1465 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1465);
            this.var_1464 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1464);
            this.var_1186 = true;
         }
      }
      ...
      {
         return this.var_724.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_724.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_211[param1].getDesktopWindow().getChildAt(this.var_724.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_211[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_429.length > 0)
         {
            this.var_1463.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_475 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1463.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_429.length > 0)
         {
            WindowContext.var_429.flush();
         }
         MouseCursorControl.change();
         this.var_1463.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1910,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1997,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2062,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1899,param2.name + ": " + param2.toString());
            }
         }
      }
