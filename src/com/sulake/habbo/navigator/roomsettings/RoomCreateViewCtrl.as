package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1347:TextFieldManager;
      
      private var var_47:Array;
      
      private var var_1346:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_717 = new Timer(100);
         this.var_717.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_47 = new Array();
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_717)
         {
            this.var_717.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_717.reset();
            this.var_717 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1346.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2118 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2118 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_207 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         ...
         this.var_1347 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_207.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_207.desktop,this.var_207.width,this.var_207.height);
         this.var_207.x = _loc4_.x;
         this.var_207.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1347.goBackToInitialState();
         this.var_1347.input.textBackgroundColor = 4294967295;
         this.var_1346 = this.var_47[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_63.numListItems > 0)
         {
            _loc6_ = this.var_63.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_47)
         {
         ...
         while(_loc4_ < this.var_47.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_63.addListItem(_loc3_);
               }
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_63.addListItem(_loc8_);
            }
         }
      }
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         _loc6_.setParamFlag(HabboWindowParam.const_45,false);
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_72,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1347.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_207.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_207.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1347.getText();
         var _loc3_:String = "model_" + this.var_1346.name;
