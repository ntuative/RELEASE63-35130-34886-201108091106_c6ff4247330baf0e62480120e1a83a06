package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1637:CutToWidth = new CutToWidth();
      
      private static var var_2835:CutToHeight = new CutToHeight();
      ...
      public static function setProc(param1:IWindowContainer, param2:String, param3:Function) : void
      {
         ...
         _loc4_.setParamFlag(HabboWindowParam.const_45,true);
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1637.beforeSearch(param2,param1,param3);
         binarySearch(var_1637,param2.length - 1);
      }
