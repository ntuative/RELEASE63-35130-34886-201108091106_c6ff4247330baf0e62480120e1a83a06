package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_349:MainViewCtrl;
      
      private var var_736:RoomInfoViewCtrl;
      
      private var var_1381:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_505:Tabs;
      ...
      private var var_2946:Array;
      
      private var var_2590:RoomThumbnailRenderer;
      
      private var var_999:GuestRoomPasswordInput;
      
      private var var_333:GuestRoomDoorbell;
      
      private var var_1380:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2946 = new Array();
         ...
         this.var_349 = new MainViewCtrl(this);
         this.var_736 = new RoomInfoViewCtrl(this);
         this.var_1381 = new RoomCreateViewCtrl(this);
         this.var_2590 = new RoomThumbnailRenderer(this);
         this.var_999 = new GuestRoomPasswordInput(this);
         this.var_333 = new GuestRoomDoorbell(this);
         this.var_505 = new Tabs(this);
         this.var_1380 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_384,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_349.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_349.startSearch(Tabs.const_271,Tabs.const_579,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_349.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_349.startSearch(Tabs.const_262,Tabs.const_257);
         this.var_505.getTab(Tabs.const_262).tabPageDecorator.tabSelected();
      }
