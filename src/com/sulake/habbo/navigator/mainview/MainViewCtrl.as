package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1493:int = 4;
      ...
      private var var_1006:PopularTagsListCtrl;
      
      private var var_1007:GuestRoomListCtrl;
      
      private var var_1221:OfficialRoomListCtrl;
      ...
      private var var_798:IRegionWindow;
      
      private var var_2485:int = 0;
      
      private var var_1222:TextSearchInputs;
      ...
      private const const_2115:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_1006 = new PopularTagsListCtrl(this._navigator);
         this.var_1007 = new GuestRoomListCtrl(this._navigator);
         this.var_1221 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_271 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         this.var_207 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_242 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_214 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_275 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         ...
         this.var_798 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(this.var_798 != null)
         {
            this.var_798.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_798.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_798.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         this.refreshToHotelViewButton(false);
         this.var_16.addEventListener(WindowEvent.const_40,this.onWindowResized);
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_271.getTabItemByID(_loc2_.id);
            if(_loc3_ != null)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_2053,true);
      ...
      private function createSearchInput() : void
      {
         ...
         if(this.var_1222 == null)
         {
            ...
            this.var_1222 = new TextSearchInputs(this._navigator,_loc3_);
         }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_207,["custom_content","list_content"],this.var_242.y,8);
         this.var_214.height = this.var_214.height + _loc1_ - this.var_214.y - this.var_275.height + this.var_2485;
         Util.moveChildrenToColumn(this.var_207,["list_content","custom_footer"],this.var_214.y,0);
         this.var_2485 = this.var_275.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_271.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1833 = true;
            this.var_271.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_242);
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_275);
         if(Util.hasVisibleChildren(this.var_275))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_1007,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1006,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1221,"official_rooms");
      }
      ...
      public function startSearch(param1:int, param2:int, param3:String = "-1", param4:int = 1) : void
      {
         ...
         {
            this.open();
            this.var_640 = const_694;
            this.var_214.blend = 0;
            if(this.var_242.visible)
            {
               this.var_242.blend = 0;
               this.var_275.blend = 0;
            }
         }
         else
         {
            this.var_640 = const_1072;
         }
         this.var_1508 = 0;
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_640 == const_1072)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_214.blend - _loc2_));
            this.var_214.blend = _loc3_;
            this.var_242.blend = !!this.var_1220 ? Number(_loc3_) : Number(1);
            this.var_275.blend = !!this.var_1220 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_640 = const_694;
            }
         }
         else if(this.var_640 == const_694)
         {
            ...
            {
               this.var_640 = const_1071;
            }
         }
         else if(this.var_640 == const_1071)
         {
            this.refresh();
            this.var_640 = const_1493;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_1006);
         this.refreshScrollbar(this.var_1007);
      }
      ...
      {
         this._navigator.refreshButton(this.var_798,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_798,"icon_hotelview_reactive",param1,null,0);
      }
