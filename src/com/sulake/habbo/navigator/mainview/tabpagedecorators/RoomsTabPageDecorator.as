package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_151:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_151 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_151.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_151 != null)
         {
            this.var_151.removeEventListener(WindowEvent.const_47,this.onFilterSelected);
            this.var_151.selection = 0;
            this.var_151.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_151 == null ? 0 : int(this.var_151.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_457);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_861);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_236,Tabs.const_457,"" + _loc3_);
         }
         if(this.var_151)
         {
            this._navigator.trackNavigationDataPoint(this.var_151.enumerateSelection()[this.var_151.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_151 ? this.var_151.enumerateSelection()[this.var_151.selection] : null;
      }
   }
}
