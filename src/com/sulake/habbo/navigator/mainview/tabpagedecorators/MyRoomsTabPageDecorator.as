package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_151 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.prepareSubNavi();
      ...
      private function startSearch() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_262,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_825;
         }
         if(param1 == 2)
         {
            return Tabs.const_919;
         }
         if(param1 == 3)
         {
            return Tabs.const_1005;
         }
         if(param1 == 4)
         {
            return Tabs.const_974;
         }
         return Tabs.const_257;
      }
