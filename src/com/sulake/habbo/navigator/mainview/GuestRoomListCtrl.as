package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_588:RoomPopupCtrl;
      
      private var var_614:IScrollbarWindow;
      
      private var var_1335:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_588 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1335 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_614 = IScrollbarWindow(this.var_207.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_614.scrollV = 0;
         }
         this.var_207.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getVisibleEntryCount() : int
      {
         ...
         {
            if(this.var_63.getListItemAt(_loc2_).visible)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_194,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_45,true);
         _loc2_.setParamFlag(HabboWindowParam.const_2036,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_238,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_128,null,0);
         this.refreshRoomName(param1,param2);
         this.var_1335.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_588.visible && this.var_2839)
         {
            return;
         }
         ...
         this.var_588.room = _loc4_;
         this.var_588.showPopup(_loc2_);
      }
      ...
      {
         var _loc2_:int = 0;
         if(this.var_1641 != null)
         {
            _loc2_ = this.var_1641.tags[0];
            this.var_1641.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2840 - _loc2_.stageX);
         this.var_2840 = _loc2_.stageX;
         this.var_2839 = _loc3_ > 2;
      }
   }
}
