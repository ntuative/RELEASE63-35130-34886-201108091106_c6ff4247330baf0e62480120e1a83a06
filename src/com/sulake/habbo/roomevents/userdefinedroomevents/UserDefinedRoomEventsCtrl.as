package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1573:int = 2;
      ...
      private var var_1972:ConditionTypes;
      
      private var var_289:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_830:RoomObjectHightLighter;
      
      private var var_198:UserDefinedRoomEventsHelp;
      
      private var var_1276:SliderWindowController;
      ...
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         ...
         this.var_1972 = new ConditionTypes();
         this.var_289 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_830 = new RoomObjectHightLighter(param1);
         this.var_198 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_289[param1];
            this.var_830.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_289[param1] = param2;
            this.var_830.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_94.getXmlWindow("ude_main"));
         ...
         this.var_1276 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1276.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1276.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_94.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_94.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_830.hideAll(this.var_289);
         }
      }
      ...
      public function method_5(param1:Triggerable) : void
      {
         var _loc3_:int = 0;
         var _loc4_:* = null;
         var _loc5_:* = null;
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_94.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_94.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_94.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_94.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_94.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1276.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_198.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1573) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1573 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_94.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1972);
      ...
      {
         var _loc2_:IFurnitureData = this.var_94.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_94.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_94.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_94.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_94.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_94.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_94.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_94.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_94);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         this.var_94.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_94.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
