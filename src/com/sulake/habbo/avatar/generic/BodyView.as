      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_78.controller.gender)
         {
            case FigureData.const_90:
               activateTab(this.const_738);
               inactivateTab(this.const_739);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_739);
               inactivateTab(this.const_738);
         }
      }
