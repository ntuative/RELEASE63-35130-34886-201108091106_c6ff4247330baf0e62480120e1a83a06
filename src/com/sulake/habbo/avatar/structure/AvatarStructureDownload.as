package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1341:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2849:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_233);
            }
            this.var_2105 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2849.appendXML(this.var_2105);
         dispatchEvent(new Event(AvatarStructureDownload.const_1341));
      }
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_233);
      }
   }
}
