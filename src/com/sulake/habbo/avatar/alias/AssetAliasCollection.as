package com.sulake.habbo.avatar.alias
{
   ...
   public class AssetAliasCollection
   {
      ...
      private var var_741:Dictionary;
      
      private var var_976:AvatarRenderManager;
      
      public function AssetAliasCollection(param1:AvatarRenderManager, param2:AssetLibraryCollection)
      {
         super();
         this.var_976 = param1;
         this.var_741 = new Dictionary();
         this._assets = param2;
      }
      ...
      public function addAlias(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         this.var_741[param1] = _loc6_;
      }
      
      public function hasAlias(param1:String) : Boolean
      {
         var _loc2_:AssetAlias = this.var_741[param1] as AssetAlias;
         return _loc2_ != null;
      }
      
      public function getAliasByName(param1:String) : AssetAlias
      {
         return this.var_741[param1] as AssetAlias;
      }
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         {
            _loc4_ = this.var_741[param1] as AssetAlias;
            param1 = _loc4_.link;
            _loc2_--;
         }
