   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_227,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_312,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_286,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_78 && var_167 == "")
         {
            var_78.switchCategory(FigureData.const_227);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_pants":
                  ...
                  break;
               case "tab_shoes":
                  this.switchCategory(FigureData.const_312);
                  break;
               case "tab_belts":
