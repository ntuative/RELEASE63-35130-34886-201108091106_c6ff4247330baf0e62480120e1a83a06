package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2988:uint;
      
      private var var_2987:uint;
      ...
      private var var_1824:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_841 = new ColorTransform(this.var_1824,this.var_1828,this.var_1827,this._alphaMultiplier);
         this.var_1398 = this.generatePaletteMapForGrayscale(this.var_2987,this.var_2988);
      }
      ...
      {
         return this.var_1398.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1398.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1398.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1398.getValue("alphas") as Array;
      }
