package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2426:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_282)
         {
            for each(_loc2_ in this.var_282 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1026 >= 0 && this._parts.length > this.var_1026)
         {
            _loc2_ = this._parts[this.var_1026];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_282 || this.var_282.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_282[0] as Array;
      ...
      private function method_4() : Array
      {
         var _loc2_:* = null;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_282.length <= param1)
         {
            return null;
         }
         return this.var_282[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_1026] as AvatarEditorGridPartItem;
      }
      
      private function updatePartColors() : void
      {
         var _loc2_:* = null;
         var _loc1_:Array = this.method_4();
      ...
      public function hasClubSelectionsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc3_:Array = this.method_4();
         if(_loc3_)
         {
            _loc6_ = 0;
