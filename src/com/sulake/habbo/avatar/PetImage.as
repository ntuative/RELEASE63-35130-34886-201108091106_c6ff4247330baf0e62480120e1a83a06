package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_299:AvatarImageCache;
      
      private var var_661:int = 0;
      
      private var var_1743:int = 0;
      
      private var var_630:AvatarFigureContainer;
      
      private var var_662:Boolean;
      
      private var var_233:Array;
      
      private var var_616:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_630 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_630.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1454 = this.var_1422;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1454);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_661);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_630,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1454 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_661);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_661);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_630,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_111)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_661);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_553 = this.var_553 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_419:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1811:
                  case AvatarAction.const_1939:
                  case AvatarAction.const_1810:
                  case AvatarAction.const_1232:
                  case AvatarAction.const_1363:
                  case AvatarAction.const_1826:
                  case AvatarAction.const_1996:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_960);
         this.getCache().resetBodyPartCache(this.var_960);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1455 = this._structure.sortActions(this.var_361);
         ...
         {
            this.var_910 = this._structure.getCanvasOffsets(this.var_1455,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1455)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_448)
               {
                  this.var_961 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_362)
               {
                  this.var_961 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1422 = _loc4_.id;
                     this.var_1742 = _loc4_.breed;
                     break;
                  }
               }
            }
