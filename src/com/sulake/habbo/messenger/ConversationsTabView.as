package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      private var var_1229:int = 30;
      
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         super();
         this._messenger = param1;
         this.var_207 = IWindowContainer(param2.findChildByName("content"));
         this.var_1010 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_207.findChildByName("convo_bg"));
         _loc3_.bitmap = this._messenger.getButtonImage("convo_bg");
      }
      
      public function getTabCount() : int
      {
         return Math.floor(this.var_1010.width / this.var_1229);
      }
      ...
      {
         var _loc3_:IWindowContainer = this.var_1010.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
         ...
         _loc3_.x = param1 * this.var_1229;
         _loc3_.width = this.var_1229;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_1010.width % this.var_1229;
         _loc3_.width = this.var_1229 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_190 ? this._messenger.conversations.findConversation(param2.id) : this._messenger.conversations.openConversations[_loc3_ + this._messenger.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
