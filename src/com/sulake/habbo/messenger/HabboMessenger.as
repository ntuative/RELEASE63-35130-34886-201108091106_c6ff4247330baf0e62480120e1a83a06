package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_478:Conversations;
      
      private var var_200:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this._configuration && this._localization && this._friendList && this.var_957 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_478 = new Conversations(new ConversationsDeps(this));
         this.var_200 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_478.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_478.setSelected(_loc2_);
            this.var_200.openMessenger();
            this.var_200.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_478 ? this.var_478.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_478.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_478.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1199);
         }
      }
      
      public function isOpen() : Boolean
      {
         return this.var_200 && this.var_200.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_200)
         {
            if(this.var_200.isMessengerOpen())
            {
               this.var_200.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_752,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1277,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_478.addMessageAndUpdateView(param1);
         if(!this.var_200.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1255);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1262,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_478.addMessageAndUpdateView(_loc3_);
      }
