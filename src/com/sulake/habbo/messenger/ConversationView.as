package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1142:int = 100;
      
      private static const const_1664:int = 20;
       
      
      private var _messenger:HabboMessenger;
      
      private var var_2787:IScrollbarWindow;
      
      private var var_2066:IContainerButtonWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_577:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this._messenger = param1;
         this.var_2066 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_63 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2787 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1142 + const_1664)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1665;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_577 == null || _loc1_.id != this.var_577.id)
         {
            this.var_577 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_577.followingAllowed)
         {
            this.var_2066.enable();
         }
         else
         {
            this.var_2066.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_63.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_577.messages.length - const_1142);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_577.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_577.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_1045 || param3.type == Message.const_752 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_577.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._messenger.send(new FollowFriendMessageComposer(this.var_577.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1016)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1277)
         {
            return 4288269465;
         }
         return 4291611852;
