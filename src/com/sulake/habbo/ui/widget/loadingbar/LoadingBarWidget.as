package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_541:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_541.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_541 = null;
         }
         if(this.var_48 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_110,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_110,this.onShowLoadingBar);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_341,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_110,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_110,this.onShowLoadingBar);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_341,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_541 == null)
         {
            ...
            this.var_541.addChild(new Bitmap(this.var_48));
            this.var_541.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_541.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_48;
            }
         }
         _loc2_.setDisplayObject(this.var_541);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_110)
         {
            return;
         }
         if(!this.createWindow())
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_341)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1359 != "")
         {
            HabboWebTools.openWebPage(this.var_1359);
         }
      }
   }
}
