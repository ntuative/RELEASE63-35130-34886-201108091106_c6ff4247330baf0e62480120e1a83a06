package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_902:String = "MISV_BUY_MORE";
      
      public static const const_840:String = "MISV_PREVIEW_PLAYING";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_509.getValues())
         {
            _loc1_.destroy();
         }
         this.var_509 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_509[param1] as IWindowContainer,0);
         this.var_54 = param1;
      }
      
      public function set songName(param1:String) : void
      {
         if(this.var_2081 == null)
         {
            return;
         }
         this.var_2081.text = param1;
      }
      
      public function set authorName(param1:String) : void
      {
         if(this.var_2082 == null)
         {
            return;
         }
         this.var_2082.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_840,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_902,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_509.add(const_840,_loc1_);
            this.var_2081 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2082 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_654));
         ...
         if(_loc1_ != null)
         {
            this.var_509.add(const_902,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_650));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_509[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
