package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_879:String = "PLSV_ADD_SONGS";
      
      public static const const_1279:String = "PLSV_START_PLAYBACK";
      
      public static const const_508:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_508)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_509[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_509[const_879];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_509.add(const_508,_loc1_);
