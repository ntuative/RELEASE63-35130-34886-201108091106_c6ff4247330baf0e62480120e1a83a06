package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1537:int = 130;
      
      private static const const_1536:int = 100;
      
      private static const const_1535:int = 130;
      
      private static const const_1534:int = 100;
      
      private static const const_1533:int = 130;
      
      private static const const_1538:int = 100;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_754,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_945,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_880,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_856,this.onSongDiskInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_106,this.onPlayListUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_161,this.onPlayListFullEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_103,this.onNowPlayingChangedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_142,this.onNowPlayingChangedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_138,this.onNowPlayingChangedEvent);
      }
      
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_754,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_945,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_880,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_856,this.onSongDiskInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_106,this.onPlayListUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_161,this.onPlayListFullEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_103,this.onNowPlayingChangedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_142,this.onNowPlayingChangedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_138,this.onNowPlayingChangedEvent);
      }
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1536 + const_1537);
         _loc3_ = uint(_loc3_ % const_1534 + const_1535);
         _loc4_ = uint(_loc4_ % const_1538 + const_1533);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_984,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_756,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_991,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      {
         var _loc1_:RoomWidgetPlayListUserActionMessage = new RoomWidgetPlayListUserActionMessage(RoomWidgetPlayListUserActionMessage.const_899);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc1_);
         }
         this._catalog.openCatalogPage(CatalogPageName.const_2031,true);
      }
