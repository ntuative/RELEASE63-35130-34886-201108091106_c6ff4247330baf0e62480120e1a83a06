package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1463:Number = 100;
      
      private static const const_1461:Number = 100;
      ...
      private var var_711:DimmerViewColorGrid;
      
      private var var_492:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1463,const_1461,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_711 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_492 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_271 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_271.numTabItems)
         {
            _loc6_ = this.var_271.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_45,true);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1640 = _loc2_.light;
         if(this.var_492 != null)
         {
            this.var_492.setValue(this.var_1640);
         }
         this.var_565 = this.colors.indexOf(_loc2_.color);
         if(this.var_711 != null)
         {
            this.var_711.setSelectedColorIndex(this.var_565);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_271.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_271.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_271.selector.getSelected();
         return this.var_271.selector.getSelectableIndex(_loc1_);
      }
      
      private function get windowXML() : XML
      {
         if(this.var_1639 != null)
         {
         ...
         this.var_1639 = XML(_loc1_.content);
         return this.var_1639;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_492 != null)
         {
            this.var_492.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_711 != null)
         {
            this.var_711.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
