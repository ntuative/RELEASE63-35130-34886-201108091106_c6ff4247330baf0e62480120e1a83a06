package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_665,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_665,this.onEditPostItRequest);
      }
      ...
      {
         hideInterface(false);
         var_234 = param1.objectId;
         this.var_456 = param1.location;
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_234 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_778,var_234,this.var_456,_text,var_360);
