package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_713:String = "welcome_gift_email_unverified";
      
      private const const_1120:String = "welcome_gift_email_verified";
      
      private const const_1613:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1279)
         {
            this.setViewState(this.const_1120);
         }
         else
         {
            this.setViewState(this.const_713);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_713:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1051;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_29,this.var_1051);
               break;
            case this.const_1120:
            ...
            case this.const_1613:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1051);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1581;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1613);
      }
      ...
      {
         this.setViewState(!!this.var_1279 ? this.const_1120 : this.const_713);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1580 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1580));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_635,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_988,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_635,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_988,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_635:
               this.var_1581 = param1.email;
               this.var_1279 = param1.isVerified;
               this.var_1051 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1581 = this.var_1580;
            this.setViewState(this.const_713);
         }
         else
         {
            if(param1.result == this.const_2399)
            {
               this.var_1051 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1580);
