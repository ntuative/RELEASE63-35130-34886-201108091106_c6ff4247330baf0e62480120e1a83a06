package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_2406:int = 0;
      
      private const const_2129:int = 1;
      
      private var var_477:ChooserView;
      ...
      {
         if(this.var_477 != null && this.var_477.isOpen())
         {
            return this.const_2129;
         }
         return this.const_2406;
      }
      ...
      override public function initialize(param1:int = 0) : void
      {
         ...
         if(param1 == this.const_2129)
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_425);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_811,this.onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_187,this.onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_765,this.onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_811,this.onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_187,this.onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_765,this.onUpdateUserChooser);
      }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(this.var_477 == null)
         {
            this.var_477 = new ChooserView(this,"${widget.chooser.user.title}");
         }
         this.var_477.populate(param1.items,false);
      }
