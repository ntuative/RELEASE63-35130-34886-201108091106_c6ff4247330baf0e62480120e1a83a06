package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2400:int = 1000;
      ...
      private var var_677:IWindow;
      
      private var var_353:Number;
      
      private var var_396:ITextWindow;
      
      private var var_217:Timer;
      
      private var var_676:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_114 = param2;
         this._widget = param1;
         this.var_217 = new Timer(this.const_2400);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_114.isActive)
         {
            ...
            this.var_677.width = _loc2_ * this.var_353;
         }
         else
         {
            this.var_677.width = 0;
            this.var_217.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_396 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_396 == null)
            {
               return;
            }
         ...
         if(!this.var_114.isActive)
         {
            this.var_396.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_114.secondsLeft > 86400)
         {
            this.var_396.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_396.text;
            _loc2_ = Math.floor(this.var_114.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_396.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_396.text;
      ...
      public function update() : void
      {
         ...
         else
         {
            ...
            this.var_676 = this._window.findChildByName("effect_hilite");
            this.var_676.visible = false;
         }
         this.setTimeLeft();
         this.var_677 = this._window.findChildByName("loader_bar");
         if(this.var_677 != null)
         {
            this.var_353 = this.var_677.width;
            this.var_217.start();
            this.onUpdate();
         }
