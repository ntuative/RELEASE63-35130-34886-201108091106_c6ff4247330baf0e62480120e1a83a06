package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2387:int = 5;
      
      private const const_2388:int = 5;
      ...
      private var var_1174:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1175 = 0;
         this.var_1174 = param2.rectangle.clone();
         this.var_1174.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1174.width)
         {
            return false;
         }
         if(this.var_1175 + param1.height > this.var_1174.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1174.width)
         {
            this._offsetX = 0;
            this.var_1175 += param1.height + this.const_2388;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1175);
         this._offsetX += param1.width + this.const_2387;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1457 != null && this.var_1457.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_182);
