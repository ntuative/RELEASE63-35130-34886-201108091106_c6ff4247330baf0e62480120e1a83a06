package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1120:TagListRenderer;
      ...
      private const const_728:int = 5;
      
      private const const_2139:int = 3;
      
      private const const_1697:int = 11184810;
      
      private const const_1696:int = 16777215;
      
      private const const_2413:int = 2000;
      
      private const const_2140:int = 50;
      
      private const const_2141:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1120 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2858 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         if(_loc7_ != null && !param2)
         {
            ...
            _loc7_.addEventListener(WindowMouseEvent.const_25,this.hideGroupBadgeInfo);
         }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.var_160.findChildByName("name").caption = "${group.badgepopup.caption}";
         this.var_160.findChildByName("description").caption = "${group.badgepopup.body}";
         var _loc3_:Rectangle = new Rectangle();
         _loc2_.getGlobalRectangle(_loc3_);
         this.var_160.x = _loc3_.left - this.var_160.width;
         this.var_160.y = _loc3_.top + (_loc3_.height - this.var_160.height) / 2;
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_728;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1697;
            }
            else
            {
               _loc5_.textColor = this.const_1696;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_728,this.const_2140);
         _loc5_.height = Math.max(_loc5_.height,this.const_2141);
         _loc3_.height = _loc5_.height + this.const_2139;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_342,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_342,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1120.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_851:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_855:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2859 > this.const_2413 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2859 = _loc6_;
               _loc3_.textColor = this.const_1696;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1697;
         }
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_728,this.const_2140);
         _loc3_.height = Math.max(_loc3_.height,this.const_2141);
         _loc2_.height = _loc3_.height + this.const_2139;
      }
