package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1639:int = 162;
      
      private static const const_1646:int = 16;
      
      private static const const_720:int = 4;
      
      private static const const_1638:uint = 14342874;
      
      private static const const_1637:uint = 3815994;
      
      private static const const_1642:uint = 2085362;
      
      private static const const_1640:uint = 39616;
      
      private static const const_1634:uint = 10513106;
      
      private static const const_1641:uint = 8734654;
      
      private static const const_1645:uint = 9094430;
      
      private static const const_1636:uint = 6200576;
      
      private static const const_1647:String = "happiness";
      
      private static const const_1635:String = "experience";
      
      private static const const_1644:String = "energy";
      
      private static const const_1643:int = 250;
      
      private static const const_1139:int = 25;
      
      private static const const_1140:int = 5;
      ...
      private var var_223:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1647,param1.nutrition,param1.nutritionMax,const_1640,const_1642);
         this.updateStateElement(const_1635,param1.experience,param1.experienceMax,const_1641,const_1634);
         this.updateStateElement(const_1644,param1.energy,param1.energyMax,const_1636,const_1645);
         ...
         this.updateWindow();
         this.var_562 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_223 && this.var_223.isVisible() && param1.isOwnPet)
         {
            this.var_223.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_223.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1639,const_1646,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1638);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1637);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_720,_loc7_.width - 2,_loc7_.height - 2 - const_720);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_720);
      ...
      private function openTrainView() : void
      {
         if(this.var_223 == null)
         {
            this.var_223 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_562) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_223.showWindow(true);
            this.var_223.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_223 && this.var_223.getPetId() == this.var_562)
               {
                  this.var_223.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_2075,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_403,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1139 + const_1140;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1140;
            }
         }
         this.var_109.height = _loc4_ + const_1139;
         this.updateWindow();
      }
   }
}
