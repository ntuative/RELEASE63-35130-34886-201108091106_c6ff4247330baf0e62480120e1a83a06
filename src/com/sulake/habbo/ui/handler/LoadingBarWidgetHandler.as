package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_580;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_573);
         _loc1_.push(InterstitialEvent.const_624);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_110);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_341);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_573:
               ...
               break;
            case InterstitialEvent.const_624:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_110:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_341:
               this._container.events.dispatchEvent(param1);
         }
      }
