package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_249.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_201,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_192,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_118,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_201,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_192,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_118,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_679.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_679.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_249 != null)
         {
            this.var_249.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_513);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_935);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_583);
         _loc1_.push(RoomWidgetUserActionMessage.const_1033);
         _loc1_.push(RoomWidgetFurniActionMessage.const_256);
         _loc1_.push(RoomWidgetFurniActionMessage.const_962);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1030);
         _loc1_.push(RoomWidgetFurniActionMessage.const_970);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1196);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_800);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_833);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_1019);
         _loc1_.push(RoomWidgetUserActionMessage.const_524);
         _loc1_.push(RoomWidgetUserActionMessage.const_664);
         _loc1_.push(RoomWidgetUserActionMessage.const_617);
         _loc1_.push(RoomWidgetUserActionMessage.const_1984);
         _loc1_.push(RoomWidgetPetCommandMessage.const_532);
         _loc1_.push(RoomWidgetPetCommandMessage.const_903);
         _loc1_.push(RoomWidgetUserActionMessage.const_671);
         _loc1_.push(RoomWidgetUserActionMessage.const_308);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_524)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_308 || param1.type == RoomWidgetUserActionMessage.const_671 || param1.type == RoomWidgetUserActionMessage.const_617)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_513:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_935:
            ...
            case RoomWidgetUserActionMessage.const_602:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1411,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_607:
               ...
               break;
            case RoomWidgetUserActionMessage.const_583:
            ...
            case RoomWidgetFurniActionMessage.const_1196:
               ...
               break;
            case RoomWidgetUserActionMessage.const_308:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_800:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_833:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_1019:
               ...
               break;
            case RoomWidgetUserActionMessage.const_524:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_310);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_375);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_461) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_461);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_1032) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1334;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_310);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1350);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1275);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_539)
                  {
                     _loc30_ = this.var_249.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_467) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_467.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_249.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_240)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_135)
               {
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_344);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_145)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_926);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_851;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_855;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1786);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_177];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_177:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_679.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_679.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_926);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_249 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_249.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_434,_loc2_,_loc3_,_loc4_));
         }
      }
