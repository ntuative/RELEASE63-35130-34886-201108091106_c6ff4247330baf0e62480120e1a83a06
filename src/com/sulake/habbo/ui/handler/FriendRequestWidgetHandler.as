package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_933);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_934);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_824);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_933:
               ...
               _loc4_ = _loc3_.userDataManager.getUserDataByType(_loc2_.userId,_loc2_.method_1);
               if(_loc4_)
               {
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_934:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_824:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_94);
         _loc1_.push(FriendRequestEvent.const_59);
         _loc1_.push(FriendRequestEvent.const_206);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_94:
               ...
               break;
            case FriendRequestEvent.const_59:
            case FriendRequestEvent.const_206:
