package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_163)
            {
               delete this.var_163[_loc1_];
            }
            this.var_163 = null;
         }
         this._length = 0;
      ...
      {
         return this.var_163[param1];
      }
      
      public function remove(param1:*) : *
      {
         var _loc2_:Object = this.var_163[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_163[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_1349);
            }
         }
         this.var_163[param1] = param2;
