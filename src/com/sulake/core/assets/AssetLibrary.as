package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1435:String = "AssetLibraryReady";
      
      public static const const_959:String = "AssetLibraryLoaded";
      
      public static const const_2055:String = "AssetLibraryUnloaded";
      
      public static const const_1950:String = "AssetLibraryLoadError";
      
      private static const const_704:String = "name";
      
      private static const const_1168:String = "asset";
      
      private static const const_1170:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1169:String = "library";
      
      private static var var_350:Dictionary;
      
      private static var var_2175:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_603:uint = 0;
      
      private static var var_1127:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_602 = new Dictionary(false);
         this.var_1130 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_737 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1169);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1168);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1170);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_737 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1127.splice(var_1127.indexOf(this),1);
            --var_603;
            this.var_602 = null;
            this.var_1130 = null;
            this.var_187 = null;
      ...
      {
         if(this.var_737 == param1.url && this.var_1129)
         {
            if(!this.var_1128 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_738);
            }
            this.var_1128 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1435));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1130)
         {
            delete this.var_1130[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1129 = false;
         this.var_737 = null;
         dispatchEvent(new Event(AssetLibrary.const_2055));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1130[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_602[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1345,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1211,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1261,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_602[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_602[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_502;
                     this.var_501.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_602[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_501.length ? this.getAssetByName(this.var_501[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_187)
         {
            ...
            {
               return this.var_501.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_187[param1] != null || (this.var_738 != null ? this.var_738[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               ++this.var_502;
               this.var_501.push(param1);
            }
            this.var_187[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2175.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_187)
            {
               if(this.var_187[_loc2_] == param1)
               {
                  this.var_501.splice(this.var_501.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_350.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_350[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_350[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_350)
            {
               _loc3_ = AssetTypeDeclaration(var_350[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_350)
            {
               _loc4_ = AssetTypeDeclaration(var_350[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_738 = _loc2_.resource;
         this.var_737 = _loc2_.url;
         if(this.var_1128)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_738);
         }
         this.var_1129 = true;
         dispatchEvent(new Event(AssetLibrary.const_959));
         dispatchEvent(new Event(AssetLibrary.const_1435));
         if(this.var_1128)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1950));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1169);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1168);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_704) && _loc3_.attribute(const_704).toString() == param1)
                  {
                     ...
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_737 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_738[param1]);
                     _loc6_ = _loc3_.child(const_1170);
