package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_744:uint = 1;
      
      public static const const_1214:uint = 2;
      
      public static const const_832:uint = 4;
      
      public static const const_1972:uint = 8;
      
      public static const const_1783:uint = 16;
      
      public static const const_2293:uint = 64;
      
      public static const const_2278:uint = 128;
      
      public static const const_1390:uint = 256;
      
      protected static var var_623:uint = 0;
      
      protected static var var_363:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1214:
               ...
               break;
            case GraphicContext.const_1972:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1783:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_832:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1390:
               break;
            case GraphicContext.const_1872:
               break;
            default:
         ...
         if(this.var_954)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_363 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_954)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_363 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      public function method_8(param1:int) : IGraphicContext
      {
