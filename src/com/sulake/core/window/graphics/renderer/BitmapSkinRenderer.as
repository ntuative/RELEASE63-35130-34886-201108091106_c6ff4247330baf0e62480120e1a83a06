package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_515[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               ...
               this.var_841.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_841);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_358 == SkinLayoutEntity.const_376)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_589)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_329)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_358 == SkinLayoutEntity.const_571)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_359 == SkinLayoutEntity.const_376)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_589)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_329)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_571)
                  {
                  ...
                  else if(_loc10_.var_359 == SkinLayoutEntity.const_329 || _loc10_.var_358 == SkinLayoutEntity.const_329)
                  {
                  ...
                  {
                     this.var_291.a = REGION.width;
                     this.var_291.d = REGION.height;
                     this.var_291.tx = REGION.x;
                     this.var_291.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_291,ALPHA);
                  }
                  else
                  {
                     this.var_291.a = 0 / _loc18_.width;
                     this.var_291.d = 0 / _loc18_.height;
                     this.var_291.tx = 0;
                     this.var_291.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_291);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_291,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_358 == SkinLayoutEntity.const_376)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_359 == SkinLayoutEntity.const_376)
               {
