package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_431:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_613:Dictionary;
      
      protected var var_515:Dictionary;
      ...
      public function SkinRenderer(param1:String)
      {
         ...
         this.var_613 = new Dictionary();
         this.var_515 = new Dictionary();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_613)
            {
               ISkinLayout(this.var_613[_loc1_]).dispose();
               delete this.var_613[_loc1_];
            }
            this.var_613 = null;
            this.var_515 = null;
            for(_loc1_ in this.var_431)
            {
               ISkinTemplate(this.var_431[_loc1_]).dispose();
               delete this.var_431[_loc1_];
            }
            this.var_431 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_431[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_613[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_431[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_515)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_515[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_613[param1.name];
         }
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_431[param1.name];
         }
         return param1;
      }
   }
