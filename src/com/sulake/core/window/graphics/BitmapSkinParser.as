package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_104:String = "default";
      
      public static const const_93:String = "active";
      
      public static const const_88:String = "focused";
      
      public static const const_86:String = "hovering";
      
      public static const const_55:String = "selected";
      
      public static const const_95:String = "pressed";
      
      public static const const_91:String = "disabled";
      
      public static const const_75:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_358 = SkinLayoutEntity.const_561;
                  break;
               case "move":
                  _loc5_.var_358 = SkinLayoutEntity.const_376;
                  break;
               case "strech":
                  _loc5_.var_358 = SkinLayoutEntity.const_589;
                  break;
               case "tiled":
                  _loc5_.var_358 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_358 = SkinLayoutEntity.const_571;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_561;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_376;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_589;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_329;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_571;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_93:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_104:
               _loc10_ = 0;
               break;
