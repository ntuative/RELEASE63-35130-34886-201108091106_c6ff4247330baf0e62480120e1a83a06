package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_712:uint = 0;
      
      private static const const_1118:uint = 1;
      
      private static const const_1117:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1117) : uint(const_712);
         ...
         if(_loc5_ != const_712)
         {
            this.var_1576 = this.var_1046;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1118)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_673)
                  {
                     ...
                     _loc7_.draw(param1,this.var_137,this.var_137.rect,this.var_1046,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     this.var_1159.tx = param2.x;
                     this.var_1159.ty = param2.y;
                     this.var_841.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_137,this.var_1159,this.var_841,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1576;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1330:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_937:
               ...
               if(this.var_1046 != this.var_1576)
               {
                  this.var_673 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1301:
               ...
               break;
            case WindowRedrawFlag.const_1434:
               _loc4_ = true;
         }
         if(_loc4_)
         {
