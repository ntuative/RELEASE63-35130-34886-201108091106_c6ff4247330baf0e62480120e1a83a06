package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1186:uint = 8;
      
      private static const const_1772:String = "skin";
      
      private static const const_1771:String = "bitmap";
      
      private static const const_1769:String = "fill";
      
      private static const const_1770:String = "text";
      
      private static const const_1767:String = "label";
      
      private static const const_1768:String = "shape";
      ...
      private var var_1155:Dictionary;
      ...
      private var var_3067:Dictionary;
      
      private var var_3066:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1156 = new Dictionary();
         this.var_2226 = new Dictionary();
         this.var_3065 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2226,this.var_3065);
         this.var_3067 = new Dictionary();
         this.var_3066 = new Dictionary();
         StateCodeTable.fillTables(this.var_3067,this.var_3066);
         this.var_511 = new Dictionary();
         this.var_511[const_1772] = BitmapSkinRenderer;
         this.var_511[const_1771] = BitmapDataRenderer;
         this.var_511[const_1769] = FillSkinRenderer;
         this.var_511[const_1770] = TextSkinRenderer;
         this.var_511[const_1767] = LabelRenderer;
         this.var_511[const_1768] = ShapeSkinRenderer;
         this.var_511[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_511[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_365 == null)
         {
            var_365 = new Array();
            var_365.push(WindowState.const_75);
            var_365.push(WindowState.const_91);
            var_365.push(WindowState.const_95);
            var_365.push(WindowState.const_55);
            var_365.push(WindowState.const_86);
            var_365.push(WindowState.const_88);
            var_365.push(WindowState.const_93);
            var_365.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3073 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2226[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1155[param1] == null)
         {
            this.var_1155[param1] = new Array(const_1186);
         }
         this.var_1155[param1][param2] = param3;
         if(this.var_1156[param1] == null)
         {
            this.var_1156[param1] = new Array(const_1186);
         }
         this.var_1156[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1155[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1156[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_101)
