package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1681:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1682:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_188:IProfiler;
      
      private var var_25:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3128:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3128 = new Array();
         this.var_188 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1681() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_188)
         {
            this.var_188.removeStopEventListener(this.refresh);
            this.var_188 = null;
         }
         if(!this.var_188 && param1)
         {
            this.var_188 = param1;
            this.var_188.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_651)
            {
               this.var_2180 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_188.getProfilerAgentsInArray();
         ...
         if(this.var_2180)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_188.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_188.numBitmapAssetInstances + " / " + this.var_188.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_188.numTrackedBitmapDataInstances + " / " + this.var_188.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1682() as ByteArray;
