package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_768:Point;
      
      protected var var_149:WindowController;
      ...
      protected var var_958:IWindowContextStateListener;
      ...
      {
         super();
         this.var_768 = new Point();
         if(var_364 == null)
         {
            var_364 = new Array();
            var_364[0] = MouseCursorType.const_379;
            var_364[1] = MouseCursorType.const_30;
            var_364[2] = MouseCursorType.const_379;
            var_364[3] = MouseCursorType.const_379;
            var_364[4] = MouseCursorType.const_379;
            var_364[5] = MouseCursorType.const_30;
            var_364[6] = MouseCursorType.const_379;
         }
         if(var_316 == null)
         {
            var_316 = new Array();
            var_316[0] = WindowState.const_93;
            var_316[1] = WindowState.const_88;
            var_316[2] = WindowState.const_86;
            var_316[3] = WindowState.const_75;
            var_316[4] = WindowState.const_55;
            var_316[5] = WindowState.const_95;
            var_316[6] = WindowState.const_91;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_309;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_149 = state.var_1429 as WindowController;
         this.var_180 = state.renderer;
         this.var_958 = state.var_1426;
         eventQueue.begin();
         this.var_768.x = -1;
         this.var_768.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_768.x || event.stageY != this.var_768.y)
            {
               this.var_768.x = event.stageX;
               this.var_768.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_768,array,WindowParam.const_29);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK || event.type == MouseEvent.MOUSE_DOWN)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_958.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1429 = this.var_149;
         state.renderer = this.var_180;
         state.var_1426 = this.var_958;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testStateFlag(WindowState.const_91))
         {
            return null;
         }
         var _loc4_:* = false;
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_149 && !this.var_149.disposed)
               {
                  this.var_149.update(this.var_149,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_149,param1));
                  this.var_149 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         if(!_loc4_)
         {
            _loc9_ = this.var_180.getDrawBufferForRenderable(param1);
