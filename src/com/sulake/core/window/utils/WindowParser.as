package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1292:String = "_EXCLUDE";
      
      public static const const_2228:String = "_INCLUDE";
      
      public static const const_2349:String = "_TEMP";
      
      private static const const_1541:String = "layout";
      
      private static const name_6:String = "window";
      
      private static const const_1085:String = "variables";
      
      private static const const_1086:String = "filters";
      
      private static const const_704:String = "name";
      
      private static const const_1549:String = "style";
      
      private static const const_706:String = "params";
      
      private static const const_1546:String = "tags";
      ...
      private static const const_1543:String = "visible";
      
      private static const const_1548:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1301:String = "blend";
      
      private static const const_1545:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1550:String = "treshold";
      
      private static const const_1542:String = "children";
      
      private static const const_1084:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1087:String = "height_min";
      
      private static const const_1088:String = "height_max";
      ...
      private static const const_1547:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1540:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1436:Dictionary;
      
      protected var var_1435:Dictionary;
      
      protected var var_1162:Dictionary;
      
      protected var var_1729:Dictionary;
      
      protected var var_2282:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1436 = new Dictionary();
         this.var_1435 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1436,this.var_1435);
         this.var_1162 = new Dictionary();
         this.var_1729 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1162,this.var_1729);
         this.var_2282 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1540,const_49);
         return param1.replace(const_1547,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1436)
            {
               delete this.var_1436[_loc1_];
            }
            for(_loc1_ in this.var_1435)
            {
               delete this.var_1435[_loc1_];
            }
            for(_loc1_ in this.var_1162)
            {
               delete this.var_1162[_loc1_];
            }
            for(_loc1_ in this.var_1729)
            {
               delete this.var_1729[_loc1_];
            }
            this.var_2282.dispose();
            this.var_2282 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1541)
         {
            _loc8_ = param1.child(const_1085);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1086).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1436[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_704,variables,"")));
         style = uint(this.parseAttribute(xml,const_1549,variables,style));
         params = uint(this.parseAttribute(xml,const_706,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1546,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_191));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_191));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_191));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_191));
         visible = this.parseAttribute(xml,const_1543,variables,visible.toString()) == const_705;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_706).length() > 0)
         {
            list = xml.child(const_706).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_704,variables,"") as String;
               if(this.var_1162[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_704)) + "\"!");
               }
               params |= this.var_1162[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1548,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1539);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1085)[0]),tags) as WindowController;
         if(this.hasAttribute(xml,const_1084))
         {
            window.limits.minWidth = int(this.parseAttribute(xml,const_1084,variables,window.limits.minWidth));
         }
         ...
         if(this.hasAttribute(xml,const_1087))
         {
            window.limits.minHeight = int(this.parseAttribute(xml,const_1087,variables,window.limits.minHeight));
         }
         if(this.hasAttribute(xml,const_1088))
         {
            window.limits.maxHeight = int(this.parseAttribute(xml,const_1088,variables,window.limits.maxHeight));
         }
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_705;
         blend = Number(this.parseAttribute(xml,const_1301,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1545,variables,window.clipping.toString()) == const_705;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1550,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1086).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_239)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1435[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1292) == -1)
                  {
