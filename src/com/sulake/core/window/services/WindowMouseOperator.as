package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_767:Point;
      
      protected var var_1618:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_767);
         this._window.offset(this.var_767.x - this._offset.x,this.var_767.y - this._offset.y);
      }
