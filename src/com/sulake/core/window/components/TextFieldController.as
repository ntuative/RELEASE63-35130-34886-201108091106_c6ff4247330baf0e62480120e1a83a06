package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1736:uint = 500;
      
      protected var var_1447:String = "";
      
      protected var var_1443:Boolean = false;
      
      protected var var_907:Boolean = false;
      ...
      {
         this.var_1447 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1214,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_907 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_182,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_452,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_342,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_119,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_1004,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1863);
         _loc1_.push(this.var_1443 != PropertyDefaults.const_1224 ? new PropertyStruct(PropertyDefaults.const_990,this.var_1443,PropertyStruct.const_37,true) : PropertyDefaults.const_1804);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1296 ? new PropertyStruct(PropertyDefaults.const_858,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_2046);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1336 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1926);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_990:
                  this.var_1443 = _loc2_.value as Boolean;
                  if(this.var_1443)
                  {
               ...
               case PropertyDefaults.const_858:
                  ...
                  break;
               case PropertyDefaults.const_1004:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1361:
