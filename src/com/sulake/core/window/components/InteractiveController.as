package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1736 = PropertyDefaults.const_843;
         this.var_1447 = PropertyDefaults.const_420;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_420)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_194)
            {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_885:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_420)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_885,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1821);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_843)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_799,param1.toolTipDelay,PropertyStruct.const_311,true));
         }
         else
         {
      ...
      {
         this.var_1447 = param1 == null ? "null" : param1;
      }
