package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2295:Boolean = false;
      ...
      protected var var_2294:int = 0;
      
      protected var var_2296:int = 0;
      
      protected var var_1441:Number;
      
      protected var var_1440:Number;
      
      protected var var_1442:Boolean = false;
      
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         this._spacing = PropertyDefaults.const_644;
         this.var_955 = PropertyDefaults.const_827;
         this.var_435 = PropertyDefaults.const_750;
         this.var_1169 = PropertyDefaults.const_805;
         this.var_765 = 0;
         this.var_763 = 0;
         this.var_125 = 0;
         this.var_108 = 0;
         ...
         var_190 = var_519 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_464,WindowStyle.const_101,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_144,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_210,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1169;
      }
      ...
      {
         return new Rectangle(this.var_765 * this.maxScrollH,this.var_763 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_765 = param1;
            this._container.x = -this.var_765 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_61);
            if(_events)
            {
               _loc2_ = WindowEvent.allocate(WindowEvent.const_515,this,null);
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_144,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_43:
               this.var_2294 = _loc3_;
               this.var_2296 = _loc4_;
               this.var_1441 = 0;
               this.var_1440 = 0;
               this.var_1442 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_194:
               if(this.var_1442)
               {
                  this.var_1441 = this.var_2294 - _loc3_;
                  this.var_1440 = this.var_2296 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1441 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1441 / this.var_125;
                     }
                  }
                  else if(this.var_1440 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1440 / this.var_108;
                  }
                  this.var_2294 = _loc3_;
                  this.var_2296 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_309:
               if(this.var_1442)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1441,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1440);
                  }
                  this.var_1442 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_955 && !this.var_619 && this._container)
         {
            this.var_619 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_644)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_421,this._spacing,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1266);
         }
         if(this.var_955 != PropertyDefaults.const_827)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_760,this.var_955,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1908);
         }
         if(this.var_435 != PropertyDefaults.const_750)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this.var_435,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1801);
         }
         if(this.var_1169 != PropertyDefaults.const_805)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1011,this.var_1169,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1918);
         }
         if(this.var_762 != PropertyDefaults.const_1191)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1026,this.var_762,PropertyStruct.const_140,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2005);
         }
         if(this.var_764 != PropertyDefaults.const_1422)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_797,this.var_764,PropertyStruct.const_140,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2063);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_1011:
                  ...
                  break;
               case PropertyDefaults.const_760:
                  this.var_955 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_1026:
                  this.var_762 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_797:
