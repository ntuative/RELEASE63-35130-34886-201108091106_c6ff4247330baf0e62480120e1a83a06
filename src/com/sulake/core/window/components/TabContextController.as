package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1482:String = "_SELECTOR";
      
      private static const const_1483:String = "_CONTENT";
       
      
      protected var var_1160:ITabSelectorWindow;
      
      protected var var_2275:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1160 = findChildByTag(const_1482) as ITabSelectorWindow;
            if(this.var_1160 != null)
            {
               this.var_1160.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2275 = findChildByTag(const_1483) as IWindowContainer;
         }
      ...
      {
         return !!this.var_907 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1160.numSelectables;
      }
