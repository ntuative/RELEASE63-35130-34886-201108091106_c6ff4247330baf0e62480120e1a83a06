package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1246:IItemListWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_91))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_465)
         {
            this.var_465.removeEventListener(WindowEvent.const_212,this.scrollBarEventProc);
            this.var_465.removeEventListener(WindowEvent.const_232,this.scrollBarEventProc);
            this.var_465 = null;
         }
         if(this.var_1246)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1246)
         {
            this.var_1246 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_465)
         {
            ...
            if(this.var_465)
            {
               this.var_465.addEventListener(WindowEvent.const_212,this.scrollBarEventProc);
               this.var_465.addEventListener(WindowEvent.const_232,this.scrollBarEventProc);
            }
         }
         return this.var_465;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_232)
         {
            this.hideScrollBar();
         }
      }
