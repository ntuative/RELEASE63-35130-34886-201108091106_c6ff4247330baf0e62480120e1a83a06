package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_357)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1406)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_956;
         if(this.var_956 != param1)
         {
            if(this.var_956 != null)
            {
               if(!this.var_956.disposed)
               {
                  this.var_956.deactivate();
               }
            }
            this.var_956 = param1;
