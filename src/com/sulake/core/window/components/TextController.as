package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1445:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_949:Number;
      
      protected var var_614:Number;
      
      protected var var_615:Boolean;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_461,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_461 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_461,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_234);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_954 ? true : null;
         }
      ...
      {
         this.var_949 = param1;
         this._field.scrollH = this.var_949 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_949 * this.maxScrollH,this.var_614 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_835,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1348));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1256 ? new PropertyStruct(PropertyDefaults.const_1025,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1257) : PropertyDefaults.const_1833);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_148,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_311,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1362 ? new PropertyStruct(PropertyDefaults.const_1407,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1226) : PropertyDefaults.const_1930);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1013) ? new PropertyStruct(PropertyDefaults.const_451,this._field.textColor,PropertyStruct.const_148,true) : PropertyDefaults.const_1234);
         ...
         _loc1_.push(this.var_43.left != PropertyDefaults.const_963 ? new PropertyStruct(PropertyDefaults.const_254,this.var_43.left,PropertyStruct.const_36,true) : PropertyDefaults.const_1024);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_975 ? new PropertyStruct(PropertyDefaults.const_293,this.var_43.top,PropertyStruct.const_36,true) : PropertyDefaults.const_884);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_980 ? new PropertyStruct(PropertyDefaults.const_282,this.var_43.right,PropertyStruct.const_36,true) : PropertyDefaults.const_936);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_891 ? new PropertyStruct(PropertyDefaults.const_304,this.var_43.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_802);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1235 ? new PropertyStruct(PropertyDefaults.const_818,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1961);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_140,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_140,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_140,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
