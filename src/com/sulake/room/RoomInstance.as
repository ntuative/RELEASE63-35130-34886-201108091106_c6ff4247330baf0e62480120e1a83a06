   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_293 != null)
         {
            ...
            {
               _loc3_ = this.var_293.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_293.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_293.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_293.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_293.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_293.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
