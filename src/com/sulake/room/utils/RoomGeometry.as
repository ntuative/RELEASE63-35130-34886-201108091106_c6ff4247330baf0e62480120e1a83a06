package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_599:Number = 64;
      
      public static const const_1305:Number = 32;
      ...
      private var var_1234:Vector3d;
      
      private var var_456:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1235:Vector3d;
      ...
      private var var_3107:Number = -500.0;
      
      private var var_3106:Number = 500.0;
      
      private var var_543:Map = null;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1234 = new Vector3d();
         this.var_456 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1235 = new Vector3d();
         this.var_1851 = 1;
         this.var_1849 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
      ...
      {
         this.var_456.assign(this.var_105);
         this.var_456.x *= this.var_459;
         this.var_456.y *= this.var_457;
         this.var_456.z *= this.var_458;
         return this.var_456;
      }
      ...
      {
         if(this.var_459 != param1 * this.var_1851)
         {
            this.var_459 = param1 * this.var_1851;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_457 != param1 * this.var_1849)
         {
            this.var_457 = param1 * this.var_1849;
            ++this.var_174;
         }
      }
      ...
      {
         if(this.var_458 != param1 * this.var_1850)
         {
            this.var_458 = param1 * this.var_1850;
            ++this.var_174;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_459;
         this.var_105.y /= this.var_457;
         this.var_105.z /= this.var_458;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_455.x;
         var _loc3_:Number = this.var_455.y;
         var _loc4_:Number = this.var_455.z;
         this.var_455.assign(param1);
         this._direction.assign(param1);
         if(this.var_455.x != _loc2_ || this.var_455.y != _loc3_ || this.var_455.z != _loc4_)
         {
            ++this.var_174;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_179.assign(_loc24_);
            this.var_178.assign(_loc25_);
            this.var_1234.assign(this.var_178);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_179.assign(_loc19_);
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_543 != null)
         {
            ...
            this.var_543.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_543.add(_loc3_,_loc4_);
            ++this.var_174;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_543 != null)
         {
            ...
            return this.var_543.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1235.assign(_loc22_);
         }
         else
         {
            this.var_1235.assign(_loc17_);
         }
         ++this.var_174;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_179);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_457;
         _loc2_.z *= this.var_458;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1235);
         if(_loc3_ < this.var_3107 || _loc3_ > this.var_3106)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_179);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_457;
            _loc2_.z *= this.var_458;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1235);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_179,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_459,this.var_105.y * this.var_457,this.var_105.z * this.var_458);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_178;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_459,param2.y * this.var_457,param2.z * this.var_458);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_459,param3.y * this.var_457,param3.z * this.var_458);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_459,param4.y * this.var_457,param4.z * this.var_458);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1305;
         }
         else
         {
            this.scale = const_599;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_599;
      }
