package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_389:IRoomObject;
      
      private var var_939:IGraphicAssetCollection;
      
      protected var var_525:int = -1;
      
      protected var var_150:int = -1;
      
      protected var var_103:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_233 != null)
         {
            ...
            {
               _loc1_ = this.var_233[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_939.removeReference();
         }
         this.var_939 = param1;
         if(this.var_939 != null)
         {
            this.var_939.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_233.length > param1)
         {
            _loc2_ = this.var_233[this.var_233.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
         ...
         while(this.var_233.length < param1)
         {
            ...
            this.var_233.push(_loc2_);
         }
      }
      
      public function get spriteCount() : int
      {
         return this.var_233.length;
      }
      ...
      {
         this.var_525 = 4294967295;
         this.var_150 = 4294967295;
         this.var_103 = -1;
      }
