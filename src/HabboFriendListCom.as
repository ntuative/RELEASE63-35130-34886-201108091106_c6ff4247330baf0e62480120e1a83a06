package
{
   ...
   public class HabboFriendListCom extends SimpleApplication
   {
      ...
      public static var HabboFriendListCom:Class = §§newclass(HabboFriendListCom,SimpleApplication);
      
      {
         HabboFriendListCom = HabboFriendList;
      }
      
      public function HabboFriendListCom()
      {
         super();
      }
   }
