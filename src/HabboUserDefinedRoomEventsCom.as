package
{
   ...
   public class HabboUserDefinedRoomEventsCom extends SimpleApplication
   {
      ...
      public static var HabboUserDefinedRoomEvents:Class = HabboUserDefinedRoomEvents;
      
      public static var IIDHabboUserDefinedRoomEvents:Class = IIDHabboUserDefinedRoomEvents;
       
      
      public function HabboUserDefinedRoomEventsCom()
      {
         super();
      }
   }
